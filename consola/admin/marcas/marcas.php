...
if(isset($_GET['rem']) && $_GET['rem'] == 1) {
	if(isset($_GET['id']) && $_GET['id'] != "" && $_GET['id'] != 0) {
		...
		$query_rsDel = "UPDATE l_precos_historial SET id_marca = 0 WHERE id_marca = :id";
    ...
    $rsDel->execute();
		...
		while($row_rsLinguas = $rsLinguas->fetch()) {
			$query_rsProc = "SELECT imagem1 FROM l_marcas_".$row_rsLinguas['sufixo']." WHERE id = :id";
			...
			$query_rsP = "UPDATE l_pecas_".$row_rsLinguas["sufixo"]." SET marca = 0 WHERE marca = :id";
			$rsP = DB::getInstance()->prepare($query_rsP);
			$rsP->bindParam(':id', $id, PDO::PARAM_INT, 5);
			$rsP->execute();

			$query_rsP = "DELETE FROM l_marcas_".$row_rsLinguas["sufixo"]." WHERE id = :id";
			$rsP = DB::getInstance()->prepare($query_rsP);
			$rsP->bindParam(':id', $id, PDO::PARAM_INT, 5);
			$rsP->execute();
		}
		...
		header("Location: marcas.php?r=1");
	}
}
...
<div class="page-container">
	...
	<div class="page-content-wrapper">
		<div class="page-content">
			<!-- BEGIN PAGE HEADER-->      
  		<h3 class="page-title"> <?php echo $RecursosCons->RecursosCons['marcas']; ?>  <small><?php echo $RecursosCons->RecursosCons['listagem']; ?> </small> </h3>
			<div class="page-bar">
				<ul class="page-breadcrumb">
					...
					<li>
						<a href="marcas.php"><?php echo $RecursosCons->RecursosCons['marcas']; ?> </a>
					</li>
				</ul>
			</div>
			<!-- END PAGE HEADER-->            
				...
				<div class="col-md-12">
					...
					<div class="portlet">
						<div class="portlet-title">
							<div class="caption">
								<i class="fa fa-pencil-square"></i><?php echo $RecursosCons->RecursosCons['marcas']; ?> 
							</div>
              <div class="actions"> <a href="marcas-insert.php" class="btn default yellow-stripe"> <i class="fa fa-plus"></i> <span class="hidden-480"> <?php echo $RecursosCons->RecursosCons['nova_marca']; ?>  </span> </a> </div>
            </div>
...
<script src="marcas-rpc.js" data-texto1="<?php echo $RecursosCons->RecursosCons['a_carregar']; ?>" data-texto2="<?php echo $RecursosCons->RecursosCons['selec_opcao']; ?>" data-texto3="<?php echo $RecursosCons->RecursosCons['selec_registos']; ?>"></script>
