                  ...
                  <div class="tab-content no-space">
                    <div class="tab-pane <?php if($tab_sel==1) echo "active"; ?>" id="tab_general">
                      <div class="form-body">
                        ...
                        <div class="form-group">
                          <label class="col-md-2 control-label" for="stock"><?php echo $RecursosCons->RecursosCons['prepration_label']; ?>:</label>
                          <div class="col-md-3">
                            <div class="input-group">
                      ...
                      <div class="form-group new_prod">
                        ...
                        ?>
                          <label class="col-md-3 control-label" for="regularprice">Regular Price (optional) :</label>
                            <div class="col-md-2">
                               <input type="text" class="form-control" name="regularprice[]" id="regularprice" value="<?php echo  $get_reguler_price ; ?>">
                            </div>
                        <?php } ?>
                        ...
                        ?>
                          ...
                          <div class="col-md-2">
                             <input type="text" class="form-control" name="sellingprice[]" id="sellingprice" value="<?php echo $get_selling_price; ?>">
                          </div>
                        <?php } ?>
                      ...
                      <div class="form-group new_prod">
                        <?php if ($role["roll_name"] ){
                          ...
                          <label class="col-md-3 control-label" for="productqtn">Product Quantity (optional) :</label>
                            <div class="col-md-2">
                               <input type="text" class="form-control" name="productqtn[]" id="productqtn" value="<?php echo $get_product_qulity; ?>">
                            </div>
                        <?php } ?>
                        </div>
                    </div>
