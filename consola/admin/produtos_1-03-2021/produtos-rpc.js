var ConteudoDados = function () {
    ...
    var nome_script = $('script[src*=produtos]');
      ...
      $.fn.dataTableExt.afnFiltering.push(function( oSettings, aData, iDataIndex ) {
        ...
        grid.init({
            ...
            dataTable: { // here you can define a typical datatable settings from http://datatables.net/usage/options 
                ...
                "ajax": {
                    "url": "produtos-list.php", // ajax source,
                },
    ...
    $('#bt_submete').click( function() {
      ...
      $.post("produtos-rpc.php", {op:"ordenar_registos", campos:data}, function(data){
...
$(document).on('change', '.cx_ordenar', function(event) {
  event.preventDefault();
  //console.log('price_value');
  /* Act on the event */
  var parent_tr = $(this).parents('tr');
  //console.log(parent_tr);
  var this_markup = parent_tr.find('.markup').val();
  //console.log(this_markup);
  var this_cost = parent_tr.find('.cost').val();
  var totalprice = parseFloat(this_cost) +  parseFloat((this_cost * this_markup) / 100);
  //console.log(totalprice);
  parent_tr.find('.price_value').text(totalprice.toFixed(2))
});

// function chang_costing_value(argument) {
//   var cost   = $('#cost').val();
