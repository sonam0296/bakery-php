var ConteudoDados = function () {
    ...
    var nome_script = $('script[src*=p_met_pagamento]');
    ...
    var handleProducts = function() {
        ...
        grid.init({
            ...
            dataTable: { // here you can define a typical datatable settings from http://datatables.net/usage/options 
                ...
                "ajax": {
                    "url": "p_met_pagamento-list.php", // ajax source,
                },
		...
		$('#bt_submete').click( function() {
			...
			$.post("p_met_pagamento-rpc.php", {op:"ordenar_registos", campos:data}, function(data){
				window.location='p_met_pagamento.php';
			});
			return false;
		} );
    }
