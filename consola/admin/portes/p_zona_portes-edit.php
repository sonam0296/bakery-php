...
if((isset($_POST["MM_insert"])) && ($_POST["MM_insert"] == "zona_portes_form")) {
	...
	if($_POST['nome'] != '') {
		...
		$insertSQL = "UPDATE zonas SET nome=:nome, portes_gratis1=:portes_gratis1, peso_max=:peso_max WHERE id=:id";
		...
		$query_rsMetPagamento = "SELECT id FROM met_pagamento_en ORDER BY ordem ASC";
		...
		if($totalRows_rsMetPagamento > 0) {
			...
			while($row_rsMetPagamento = $rsMetPagamento->fetch()) {
				...
				$query_rsP2 = "SELECT id FROM zonas_met_pagamento WHERE id_zona=:id_zona AND id_metodo=:id_metodo";
				...
				if(isset($_POST['met_pagamento_'.$id_metodo])) {
					...
					if($totalRows_rsP2 > 0) {
						...
						$insertSQL = "INSERT INTO zonas_met_pagamento (id_zona, id_metodo, portes, tipo) VALUES (:id, :id_metodo, :portes, :tipo)";
		...
		$query_rsMetEnvio = "SELECT id FROM met_envio_en ORDER BY met_envio_en.ordem ASC";
			...
			while($row_rsMetEnvio = $rsMetEnvio->fetch()) {
				...
				if(isset($_POST['met_envio_'.$id_metodo])) {
					...
					if($totalRows_rsP2 > 0) {
						...
						$insertSQL = "INSERT INTO zonas_met_envio (id_zona, id_metodo, portes, custo, tipo, tabela) VALUES (:id, :id_metodo, :portes, :custo, :tipo, :tabela)";
		...
		header("Location: p_zona_portes-edit.php?id=".$id."&alt=1");
...
$query_rsP = "SELECT * FROM zonas WHERE id=:id";
...
$query_rsMetPagamento = "SELECT * FROM met_pagamento_en WHERE visivel='1' ORDER BY ordem ASC";
...
$query_rsMetEnvio = "SELECT * FROM met_envio_en ORDER BY met_envio_en.ordem ASC";
        ...
        <div class="modal-dialog">
          ...
          <div class="modal-content">
            ...
            <div class="modal-footer">
              ...
              <button type="button" class="btn blue" onClick="document.location='p_zona_portes.php?rem=1&id=<?php echo $row_rsP["id"]; ?>'"><?php echo $RecursosCons->RecursosCons['txt_ok']; ?></button>
            ...
            <div class="portlet">
              ...
              <div class="portlet-title">
                ...
                <div class="form-actions actions btn-set">
                  ...
                  <?php if($row_rsP["id"] != 1) { ?><a href="#modal_delete" data-toggle="modal" class="btn red"><i class="fa fa-remove"></i> <?php echo $RecursosCons->RecursosCons['eliminar']; ?></a><?php } ?> 
                  ...
                  <div class="form-group">
                    ...
                    <div class="col-md-2">
                      ...
                      <div class="input-group">
                        ...
                        <input type="text" class="form-control" name="portes_gratis1" id="portes_gratis1" value="<?php echo $row_rsP['portes_gratis1']; ?>">
                            ...
                            <tbody>
                              ...
                              <?php $cor="#EDEDED"; while($row_rsMetPagamento = $rsMetPagamento->fetch()) { if($cor=="#EDEDED") $cor="#CCCCCC"; else $cor="#EDEDED"; 
														  	...
														  	$id_metodo=$row_rsMetPagamento['id'];
																...
																$query_rsP2 = "SELECT * FROM zonas_met_pagamento WHERE id_zona=:id AND id_metodo=:id_metodo";
	                                ...
	                                <td align="center"><table border="0" cellspacing="0" cellpadding="0">
	                                    ...
	                                    <tr>
	                                      ...
	                                      <td><div class="md-radio">
	                                          ...
	                                          <input type="radio" id="tipoP_<?php echo $row_rsMetPagamento['id']; ?>_0" name="tipoP_<?php echo $row_rsMetPagamento['id']; ?>" class="md-radiobtn" value="1" <?php if($row_rsP2["tipo"] == 1) { ?>checked<?php } ?>>

	                                          <label for="tipoP_<?php echo $row_rsMetPagamento['id']; ?>_0"> <span></span> <span class="check"></span> <span class="box"></span> &pound; </label>

	                                        </div>

	                                        <div class="md-radio">

	                                          <input type="radio" id="tipoP_<?php echo $row_rsMetPagamento['id']; ?>_1" name="tipoP_<?php echo $row_rsMetPagamento['id']; ?>" class="md-radiobtn" value="2" <?php if($row_rsP2["tipo"] == 2) { ?>checked<?php } ?>>
                            ...
                            <tbody>
                              ...
                              <?php $cor="#EDEDED"; while($row_rsMetEnvio = $rsMetEnvio->fetch()) { if($cor=="#EDEDED") $cor="#CCCCCC"; else $cor="#EDEDED"; 
							  								...
							  								$id_metodo = $row_rsMetEnvio['id'];
																...
																$query_rsP2 = "SELECT * FROM zonas_met_envio WHERE id_zona=:id AND id_metodo=:id_metodo";
	                                ...
	                                <td align="right"><table border="0" cellspacing="0" cellpadding="0">
	                                    ...
	                                    <tr>
	                                      ...
	                                      <td><div class="input-group">
	                                          ...
	                                          <span class="input-group-addon">Mi</span> </div></td>

	                                      <td width="10">&nbsp;</td>

	                                      <td height="35"><div class="md-radio">

	                                          <input type="radio" id="tipoE_<?php echo $row_rsMetEnvio['id']; ?>_0" name="tipoE_<?php echo $row_rsMetEnvio['id']; ?>" class="md-radiobtn" value="1" <?php if($row_rsP2["tipo"] == 1) { ?>checked<?php } ?>>

	                                          <label for="tipoE_<?php echo $row_rsMetEnvio['id']; ?>_0"> <span></span> <span class="check"></span> <span class="box"></span> p/ Uni </label>

	                                        </div>

	                                        <div class="md-radio">

	                                          <input type="radio" id="tipoE_<?php echo $row_rsMetEnvio['id']; ?>_1" name="tipoE_<?php echo $row_rsMetEnvio['id']; ?>" class="md-radiobtn" value="2" <?php if($row_rsP2["tipo"] == 2) { ?>checked<?php } ?>>

	                                          <label for="tipoE_<?php echo $row_rsMetEnvio['id']; ?>_1"> <span></span> <span class="check"></span> <span class="box"></span> p/ Kg </label>
