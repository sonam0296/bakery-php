...
// 		$query_rsProc = "SELECT * FROM met_envio_$lingua_consola WHERE id = :id";
...
//       @unlink('../../../imgs/carrinho/'.$row_rsProc['imagem']);
//       @unlink('../../../imgs/carrinho/'.$row_rsProc['imagem2']);
//     }
		
// 		$query_rsLinguas = "SELECT * FROM linguas WHERE visivel='1' ORDER BY ordem ASC, id ASC";
...
// 			$query_rsP = "DELETE FROM met_envio_".$row_rsLinguas["sufixo"]." WHERE id = :id";
...
// 		$query_rsP = "DELETE FROM zonas_met_envio WHERE id_metodo = :id";
// 		$rsP = DB::getInstance()->prepare($query_rsP);
// 		$rsP->bindParam(':id', $id, PDO::PARAM_INT, 5);
// 		$rsP->execute();
// 		DB::close();
		
// 		header("Location: p_met_envio.php?r=1");
// 	}
// }
        ...
        <div class="col-md-12"> 
          ...
          <div class="portlet">
            <div class="portlet-title">
              ...
              <div class="actions"> <a href="p_met_envio-insert.php" class="btn default yellow-stripe"> <i class="fa fa-plus"></i> <span class="hidden-480"> <?php echo $RecursosCons->RecursosCons['novo_registo']; ?> </span> </a> </div>
            </div>
...
<script src="p_met_envio-rpc.js" data-texto1="<?php echo $RecursosCons->RecursosCons['a_carregar']; ?>" data-texto2="<?php echo $RecursosCons->RecursosCons['selec_opcao']; ?>" data-texto3="<?php echo $RecursosCons->RecursosCons['selec_registos']; ?>"></script> 
