...
$query_rsZonas = "SELECT id, nome FROM zonas ORDER BY nome ASC";
                ...
                <table class="table table-striped table-bordered table-hover" id="datatable_products">
                  <thead>
                    <tr role="row" class="heading">
                      ...
                      <th width="20%">  <?php echo $RecursosCons->RecursosCons['zona_label']; ?> </th>
                    ...
                    <tr role="row" class="filter">
                      ...
                      <td><select name="form_zona" class="form-control form-filter input-sm" onchange="document.getElementById('pesquisa').click();">
                          <option value=""> <?php echo $RecursosCons->RecursosCons['pesq_todas']; ?></option>
                          <?php while($row_rsZonas = $rsZonas->fetch()) { ?>
                          <option value="<?php echo $row_rsZonas["id"]; ?>"><?php echo $row_rsZonas["nome"]; ?></option>
                          <?php } ?>
                        </select></td>
...
<script src="p_paises-rpc.js" data-texto1="<?php echo $RecursosCons->RecursosCons['a_carregar']; ?>" data-texto2="<?php echo $RecursosCons->RecursosCons['selec_opcao']; ?>" data-texto3="<?php echo $RecursosCons->RecursosCons['selec_registos']; ?>"></script> 
