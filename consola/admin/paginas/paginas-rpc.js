var ConteudoDados = function () {
    ...
    var nome_script = $('script[src*=paginas]');
    ...
    var handleProducts = function() {
        ...
        grid.init({
            ...
            dataTable: { // here you can define a typical datatable settings from http://datatables.net/usage/options 
                ...
                "ajax": {
                    "url": "paginas-list.php?fixo="+fixo, // ajax source,
                },
		...
		$('#bt_submete').click( function() {
			...
			$.post("paginas-rpc.php", {op:"ordenar_registos", campos:data}, function(data){
				window.location='paginas.php?fixo='+fixo;
			});
			return false;
		} );
    }
