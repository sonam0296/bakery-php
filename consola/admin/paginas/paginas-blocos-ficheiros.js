var EcommerceProductsEdit = function () {
    ...
    var nome_script = $('script[src*=paginas-blocos-ficheiros]');
    ...
    var handleImages = function() {		
        ...
        var uploader = new plupload.Uploader({
            ...
            filters : {
                max_file_size : '64mb',
                mime_types: [
                    {title : "PDF/XLS/XLSX files", extensions : "pdf,xlsx,xls"},/*
            ...
            init: {
                ...
                FileUploaded: function(up, file, response) {
                    ...
                    if (response.result && response.result == 'OK') {
						...
						$.ajax({
  						  	method: "POST",
						  	url: "paginas-blocos-ficheiros-guardar.php",
  						  	data: { id_produto: data_id, ficheiro:id, tipo: data_tipo, orientacao: data_ori, fullscreen: data_fullscreen }
						}).done(function( data ) {
							console.log("Feito "+data_id);
							$('#uploaded_file_' + file.id + ' > .status').removeClass("label-info").addClass("label-success").html('<i class="fa fa-check"></i> Done'); // set successfull upload
							if(cont2==cont) document.location='paginas-blocos-ficheiros.php?id='+data_id+'&suc=1&pagina='+data_pag+'&fixo='+data_fixo+'';
						});
                    } else {
