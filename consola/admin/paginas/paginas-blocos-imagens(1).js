var EcommerceProductsEdit = function () {
    ...
    var nome_script = $('script[src*=paginas-blocos-imagens]');
    var data_id = nome_script.attr('data-id');
    var data_tipo = nome_script.attr('data-tipo');
    var data_ori = nome_script.attr('data-ori');
    var data_pag = nome_script.attr('data-pag');
    var data_fixo = nome_script.attr('data-fixo');
    var data_colunas = nome_script.attr('data-colunas');
    var data_fullscreen = nome_script.attr('data-fullscreen');
            ...
            init: {
                ...
                FileUploaded: function(up, file, response) {
                    ...
                    if (response.result && response.result == 'OK') {
						...
						$.ajax({
  						  	method: "POST",
						  	url: "paginas-blocos-imagens-guardar.php",
  						  	data: { id_produto: data_id, ficheiro:id, tipo: data_tipo, orientacao: data_ori, colunas: data_colunas, fullscreen: data_fullscreen }
						}).done(function( data ) {
							console.log("Feito "+data_id);
							$('#uploaded_file_' + file.id + ' > .status').removeClass("label-info").addClass("label-success").html('<i class="fa fa-check"></i> Done'); // set successfull upload
							if(cont2==cont) document.location='paginas-blocos-imagens.php?id='+data_id+'&suc=1&pagina='+data_pag+'&fixo='+data_fixo+'';
						});
                    } else {
