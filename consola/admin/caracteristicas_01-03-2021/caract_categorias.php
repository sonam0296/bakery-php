...
if(isset($_GET['rem']) && $_GET['rem'] == 1) {
	if(isset($_GET['id']) && $_GET['id'] != "" && $_GET['id'] != 0) {
		...
		while($row_rsLinguas = $rsLinguas->fetch()) {
			$query_rsP = "DELETE FROM l_caract_categorias_".$row_rsLinguas["sufixo"]." WHERE id = :id";
		...
		header("Location: caract_categorias.php?r=1");
	}
}
...
<div class="page-container">
	...
	<div class="page-content-wrapper">
		<div class="page-content">
			<!-- BEGIN PAGE HEADER-->            
			<h3 class="page-title"><?php echo $RecursosCons->RecursosCons['caracteristicas']; ?> <small><?php echo $RecursosCons->RecursosCons['categorias']; ?></small> </h3>
			<div class="page-bar">
				...
				<div class="col-md-12">
					...
					<div class="portlet">
						<div class="portlet-title">
							<div class="caption">
								<i class="fa fa-folder"></i><?php echo $RecursosCons->RecursosCons['caracteristicas']; ?> - <?php echo $RecursosCons->RecursosCons['categorias']; ?>
							</div>
              <div class="actions"> <a href="caract_categorias-insert.php" class="btn default yellow-stripe"> <i class="fa fa-plus"></i> <span class="hidden-480"><?php echo $RecursosCons->RecursosCons['nova_categoria']; ?> </span> </a> </div>
            </div>
...
<!--     -->
<script src="caract_categorias-rpc.js" data-texto1="<?php echo $RecursosCons->RecursosCons['a_carregar']; ?>" data-texto2="<?php echo $RecursosCons->RecursosCons['selec_opcao']; ?>" data-texto3="<?php echo $RecursosCons->RecursosCons['selec_registos']; ?>"></script>
