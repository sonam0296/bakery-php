...
if(isset($_GET['rem']) && $_GET['rem'] == 1) {
    ...
    $totalRows_rsLinguas = $rsLinguas->rowCount();
      ...
      $query_rsP = "SELECT imagem1, imagem2, imagem3 FROM banners_h_".$row_rsLinguas["sufixo"]." WHERE id = :id";
      ...
      @unlink("../../../imgs/banners/".$row_rsP['imagem3']);
			...
			$query_rsDel = "DELETE FROM banners_h_".$row_rsLinguas["sufixo"]." WHERE id=:id";
    ...
    alteraSessions('banners');
		...
		header("Location: slideshow.php?r=1");
	}
}
...
<div class="page-container">
  ...
  <div class="page-content-wrapper">
    <div class="page-content"> 
      <!-- BEGIN PAGE HEADER-->
      <h3 class="page-title"> <?php echo $RecursosCons->RecursosCons['banner_page_title']; ?> <small><?php echo $RecursosCons->RecursosCons['listagem']; ?></small> </h3>
      <div class="page-bar">
        <ul class="page-breadcrumb">
          <li> <i class="fa fa-home"></i> <a href="../index.php"><?php echo $RecursosCons->RecursosCons['home']; ?></a> <i class="fa fa-angle-right"></i> </li>
          <li> <a href="slideshow.php"><?php echo $RecursosCons->RecursosCons['banner_page_title']; ?></a> </li>
        </ul>
      </div>
      <!-- END PAGE HEADER--> 
      <!-- BEGIN PAGE CONTENT-->
        ...
        <div class="col-md-12"> 
          ...
          <div class="portlet">
            <div class="portlet-title">
              <div class="caption"> <i class="fa fa-pencil-square"></i><?php echo $RecursosCons->RecursosCons['banner_page_title']; ?> </div>
              <div class="actions"> <a href="slideshow-insert.php" class="btn default yellow-stripe"> <i class="fa fa-plus"></i> <span class="hidden-480"> <?php echo $RecursosCons->RecursosCons['novo_banner']; ?> </span> </a> </div>
            </div>
...
<script src="<?php echo ROOTPATH_HTTP_CONSOLA; ?>assets/global/plugins/bootstrap-growl/jquery.bootstrap-growl.min.js"></script>
...
<script src="slideshow-list.js" data-texto1="<?php echo $RecursosCons->RecursosCons['a_carregar']; ?>" data-texto2="<?php echo $RecursosCons->RecursosCons['selec_opcao']; ?>" data-texto3="<?php echo $RecursosCons->RecursosCons['selec_registos']; ?>" data-texto4="<?php echo $RecursosCons->RecursosCons['alt']; ?>">></script> 
