    ...
    var handleProducts = function() {
        ...
        grid.init({
            ...
            dataTable: { // here you can define a typical datatable settings from http://datatables.net/usage/options 
                ...
                "ajax": {
                    "url": "slideshow-list.php" // ajax source
                },
            ...
            var tipo = parts['1'];
            var id = parts['2'];
            var op = 'banners_visivel';
            $.ajax({
              url: 'slideshow-rpc.php',
              type: 'POST',
              data: {op: op, valor: valor, id: id},
            })
            .done(function(data) {
              $.bootstrapGrowl(texto4, {
		...
		$('#bt_submete').click( function() {
			...
			$.post("slideshow-rpc.php", {op:"ordenar_registos", campos:data}, function(data){
