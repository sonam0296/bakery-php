...
if((isset($_POST["MM_insert"])) && ($_POST["MM_insert"] == "frm_noticias")) {
    ...
    if(isset($_POST['atualizar_url'])) {
      ...
      $nome_url = $row_rsP['url'];
		...
		// actualiza detalhes
		$insertSQL = "UPDATE noticias".$extensao." SET data=:data, nome=:nome, resumo=:resumo, descricao=:descricao, url=:url, title=:title, description=:description,tags=:tags WHERE id=:id";
		...
		$rsInsert->bindParam(':tags', $tags, PDO::PARAM_STR, 5);
		...
		if(!$manter) 
			...
			header("Location: noticias-edit.php?id=".$id."&alt=1&tab_sel=1");
	}
	                  ...
	                  <div class="tab-pane <?php if($tab_sel==1) echo "active"; ?>" id="tab_general">
	                    <div class="form-body">
	                      ...
	                      <div class="form-group">
	                        ...
	                        <div class="col-md-8">
	                          <textarea class="form-control" id="resumo" name="resumo"><?php echo $row_rsP['resumo']; ?></textarea>
	                        </div>
	                      </div>
	                      <div class="form-group">
	                        <label class="col-md-2 control-label" for="descricao"><?php echo $RecursosCons->RecursosCons['descricao_label']; ?>: </label>
	                        <div class="col-md-8">
	                          <textarea class="form-control" id="descricao" name="descricao"><?php echo $row_rsP['descricao']; ?></textarea>
	                        </div>
	                      </div>
	                      ...
	                      <div class="form-group">
		                    ...
		                    <div class="col-md-8">
		                      <input type="text" class="form-control" name="tags" id="tags" value="<?php echo $row_rsP['tags']; ?>" data-required="1">
		                    </div>
		                  </div>
