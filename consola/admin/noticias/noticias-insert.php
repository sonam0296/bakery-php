...
if((isset($_POST["MM_insert"])) && ($_POST["MM_insert"] == "frm_noticias")) {
	if($_POST['nome']!='') {
		$insertSQL = "SELECT MAX(id) FROM noticias_pt";
    ...
    $totalRows_rsLinguas = $rsLinguas->rowCount();
		...
		while($row_rsLinguas = $rsLinguas->fetch()) {
			...
			$query_rsProc = "SELECT id FROM noticias_".$row_rsLinguas['sufixo']." WHERE url like :nome_url";
      ...
      $rsProc->bindParam(':nome_url', $nome_url, PDO::PARAM_STR, 5);
			...
			$insertSQL = "INSERT INTO noticias_".$row_rsLinguas["sufixo"]." (id, data, nome, descricao, resumo, url, title, description,tags) VALUES (:id, :data, :nome, :descricao, :resumo, :url, :title, :description,:tags)";
			$rsInsert = DB::getInstance()->prepare($insertSQL);
      ...
      $rsInsert->bindParam(':resumo', $_POST['resumo'], PDO::PARAM_STR, 5);
			...
			$rsInsert->bindParam(':description', strip_tags($descricao), PDO::PARAM_STR, 5);
			$rsInsert->bindParam(':tags', $_POST['tags'], PDO::PARAM_STR, 5);	
			$rsInsert->execute();
		}
    ...
    alteraSessions('noticias');
		...
		header("Location: noticias-edit.php?id=".$id."&env=1");
	}
}
...
<div class="page-container">
  ...
  <div class="page-content-wrapper">
    <div class="page-content"> 
      <!-- BEGIN PAGE HEADER-->
      <h3 class="page-title"> <?php echo $RecursosCons->RecursosCons['noticias']; ?> <small><?php echo $RecursosCons->RecursosCons['inserir_registo']; ?></small> </h3>
      <div class="page-bar">
            ...
            <div class="portlet">
              ...
              <div class="portlet-body">
                <div class="form-body">
                  ...
                  <div class="form-group">
                    <label class="col-md-2 control-label" for="resumo"><?php echo $RecursosCons->RecursosCons['resumo_label']; ?>: </label>
                    <div class="col-md-8">
                      <textarea class="form-control" id="resumo" name="resumo"><?php echo $_POST['resumo']; ?></textarea>
                    </div>
                  </div>
                  <div class="form-group">
                  ...
                  <div class="form-group">
                    <label class="col-md-2 control-label" for="tags">Tags: <small>Comma separated tags e.g. cake,design,web etc.</small> </label>
                    <div class="col-md-8">
                      <input type="text" class="form-control" name="tags" id="tags" value="<?php echo $_POST['tags']; ?>" data-required="1">
                    </div>
                  </div>
