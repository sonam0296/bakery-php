...
if(isset($_GET['rem']) && $_GET['rem'] == 1) {
    ...
    $totalRows_rsImgs = $rsImgs->rowCount();
		...
		$query_rsDel = "DELETE FROM noticias_imagens WHERE id_peca=:id";
    ...
    $totalRows_rsLinguas = $rsLinguas->rowCount();
      ...
      $query_rsP = "SELECT imagem1, ficheiro FROM noticias_".$row_rsLinguas["sufixo"]." WHERE id = :id";
    ...
    alteraSessions('noticias');
		...
		header("Location: noticias.php?r=1");
	}
}
...
<div class="page-container">
  ...
  <div class="page-content-wrapper">
    <div class="page-content"> 
      <!-- BEGIN PAGE HEADER-->
      <h3 class="page-title"> <?php echo $RecursosCons->RecursosCons['noticias']; ?> <small><?php echo $RecursosCons->RecursosCons['listagem']; ?></small> </h3>
      <div class="page-bar">
        <ul class="page-breadcrumb">
          <li> <i class="fa fa-home"></i> <a href="../index.php"><?php echo $RecursosCons->RecursosCons['home']; ?></a> <i class="fa fa-angle-right"></i> </li>
          <li> <a href="noticias.php"> <?php echo $RecursosCons->RecursosCons['noticias']; ?> </a> </li>
        </ul>
      </div>
      <!-- END PAGE HEADER--> 
      <!-- BEGIN PAGE CONTENT-->
        ...
        <div class="col-md-12"> 
          ...
          <div class="portlet">
            <div class="portlet-title">
              <div class="caption"> <i class="fa fa-pencil-square"></i><?php echo $RecursosCons->RecursosCons['noticias']; ?> </div>
              <div class="actions"> <a href="noticias-insert.php" class="btn default yellow-stripe"> <i class="fa fa-plus"></i> <span class="hidden-480"> <?php echo $RecursosCons->RecursosCons['nova_noticia']; ?> </span> </a> </div>
            </div>
                ...
                <table class="table table-striped table-bordered table-hover" id="datatable_products">
                  <thead>
                    <tr role="row" class="heading">
                      ...
                      <th width="10%"> <?php echo $RecursosCons->RecursosCons['destaque']; ?> </th>
                    ...
                    <tr role="row" class="filter">
                      ...
                      <td>&nbsp;</td>
                      <td>&nbsp;</td>
                      <td><select name="form_destaque" class="form-control form-filter input-sm" onchange="document.getElementById('pesquisa').click();">
...
<script src="noticias-list.js" data-texto1="<?php echo $RecursosCons->RecursosCons['a_carregar']; ?>" data-texto2="<?php echo $RecursosCons->RecursosCons['selec_opcao']; ?>" data-texto3="<?php echo $RecursosCons->RecursosCons['selec_registos']; ?>"></script> 
