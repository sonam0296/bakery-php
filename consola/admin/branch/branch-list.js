var NoticiasList = function () {
    ...
    var nome_script = $('script[src*=branch]');
    ...
    var handleProducts = function() {
        ...
        grid.init({
            ...
            dataTable: { // here you can define a typical datatable settings from http://datatables.net/usage/options 
                ...
                "ajax": {
                    "url": "branch-list.php" // ajax source
                },
		...
		$('#bt_submete').click( function() {
			...
			$.post("roll-rpc.php", {op:"ordenar_registos", campos:data}, function(data){
				window.location='roll.php';
			});
			return false;
		} );
    }
