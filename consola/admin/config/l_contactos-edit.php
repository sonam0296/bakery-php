...
if((isset($_POST["MM_insert"])) && ($_POST["MM_insert"] == "frm_contactos")) {
	...
	if($_POST['nome']!='') {	
		$insertSQL = "UPDATE contactos_locais".$extensao." SET nome=:nome, texto=:texto WHERE id=:id";
    ...
    while($row_rsLinguas = $rsLinguas->fetch()) {
      $insertSQL = "UPDATE contactos_locais_".$row_rsLinguas['sufixo']." SET gps=:gps, link_google_maps=:link_google_maps WHERE id=:id";
      $rsInsert = DB::getInstance()->prepare($insertSQL);
    ...
    alteraSessions('contactos');
		...
		if(!$manter) 
			header("Location: l_contactos.php?alt=1");
		else
			header("Location: l_contactos-edit.php?id=".$id."&alt=1");			
	}
}

$query_rsP = "SELECT * FROM contactos_locais".$extensao." WHERE id = :id";
...
<div class="page-container">
  ...
  <div class="page-content-wrapper">
    <div class="page-content"> 
      <!-- BEGIN PAGE HEADER-->
      <h3 class="page-title"> <?php echo $RecursosCons->RecursosCons['contactos']; ?> <small><?php echo $RecursosCons->RecursosCons['editar_registo']; ?></small> </h3>
      <div class="page-bar">
        ...
        <div class="modal-dialog">
          <div class="modal-content">
            ...
            <div class="modal-footer">
              <button type="button" class="btn blue" onClick="document.location='l_contactos.php?rem=1&id=<?php echo $row_rsP["id"]; ?>'"><?php echo $RecursosCons->RecursosCons['txt_ok']; ?> </button>
            ...
            <input type="hidden" name="manter" id="manter" value="0">
	          <div class="portlet">
	            <div class="portlet-title">
	              <div class="caption"> <i class="fa fa-pencil-square"></i><?php echo $RecursosCons->RecursosCons['contactos_locais']; ?> - <?php echo $row_rsP["nome"]; ?> </div>
