...
if(isset($_GET['rem']) && $_GET['rem'] == 1) {
	if(isset($_GET['id']) && $_GET['id'] != "" && $_GET['id'] != 0) {
		...
		$query_rsProc = "SELECT * FROM galerias_conteudo WHERE id = :id";
		...
		if($totalRows_rsProc>0) @unlink('../../../imgs/galerias/'.$row_rsProc['imagem']);
		
		$query_rsP = "DELETE FROM galerias_conteudo WHERE id = :id";
		$rsP = DB::getInstance()->prepare($query_rsP);
		$rsP->bindParam(':id', $id, PDO::PARAM_INT, 5);
		$rsP->execute();
		DB::close();
		
		header("Location: galerias-conteudo.php?id=".$_GET['id']."&r=1");
	}
}
    ...
    <div class="page-content"> 
      ...
      <div class="page-bar">
        <ul class="page-breadcrumb">
          ...
          <li> <a href="galerias.php"><?php echo $RecursosCons->RecursosCons['galerias']; ?></a> </li>
        </ul>
      </div>
      <!-- END PAGE HEADER--> 
      <!-- BEGIN PAGE CONTENT-->
        ...
        <div class="col-md-12"> 
          ...
          <div class="portlet">
            <div class="portlet-title">
              ...
              <div class="actions"> <a href="galerias-conteudo-insert.php?id=<?php echo $_GET['id']; ?>" class="btn default yellow-stripe"> <i class="fa fa-plus"></i> <span class="hidden-480"> <?php echo $RecursosCons->RecursosCons['novo_registo']; ?> </span> </a> </div>
            </div>
                ...
                <table class="table table-striped table-bordered table-hover" id="datatable_products">
                  <thead>
                    <tr role="row" class="heading">
                      ...
                      <th width="10%"> <?php echo $RecursosCons->RecursosCons['media']; ?> </th>
                      <th width="10%"> <?php echo $RecursosCons->RecursosCons['ordem']; ?> </th>
                      <th width="10%"> <?php echo $RecursosCons->RecursosCons['visiel_tab']; ?> </th>
...
<script src="galerias-conteudo-rpc.js" data-galeria="<?php echo $_GET['id']; ?>" data-texto1="<?php echo $RecursosCons->RecursosCons['a_carregar']; ?>" data-texto2="<?php echo $RecursosCons->RecursosCons['selec_opcao']; ?>" data-texto3="<?php echo $RecursosCons->RecursosCons['selec_registos']; ?>"> </script> 
