...
$query_rsGal = "SELECT * FROM galerias_pt WHERE id=:id";
$rsGal = DB::getInstance()->prepare($query_rsGal);
$rsGal->bindParam(':id', $_GET['id_galeria'], PDO::PARAM_INT, 5);
$rsGal->execute();
$row_rsGal = $rsGal->fetch(PDO::FETCH_ASSOC);
$totalRows_rsGal = $rsGal->rowCount();
DB::close();	

$query_rsP = "SELECT * FROM galerias_conteudo WHERE id=:id";
...
if ((isset($_POST["MM_insert"])) && ($_POST["MM_insert"] == "galerias")) {
	...
	if($_POST['nome']) {
		...
		$insertSQL = "UPDATE galerias_conteudo SET nome=:nome, link=:link WHERE id=:id";
		...
		if(!$_FILES){ // apaga imagem
			...
			@unlink('../../../imgs/galerias/'.$row_rsP['imagem1']);
			$imagem='';
		...
		header("Location: galerias-conteudo-edit.php?id_galeria=".$_GET['id_galeria']."&id=".$_GET['id']."&alt=1");
...
<div class="page-container">
  ...
  <div class="page-content-wrapper">
    <div class="page-content"> 
        ...
        <div class="modal-dialog">
          <div class="modal-content">
            ...
            <div class="modal-footer">
              <button type="button" class="btn blue" onClick="document.location='galerias-conteudo.php?rem=1&id=<?php echo $_GET["id_galeria"]; ?>'"><?php echo $RecursosCons->RecursosCons['txt_ok']; ?></button>
      ...
      <h3 class="page-title"> <?php echo $RecursosCons->RecursosCons['page_title_galerias']; ?> » <?php echo $row_rsGal["nome"]; ?> </h3>
      <div class="page-bar">
            ...
            <div class="portlet">
              <div class="portlet-title">
                ...
                <div class="form-actions actions btn-set">
                  <button type="button" name="back" class="btn default" onClick="document.location='galerias-conteudo.php?id=<?php echo $_GET['id_galeria']; ?>'"><i class="fa fa-angle-left"></i> <?php echo $RecursosCons->RecursosCons['voltar']; ?></button>
              ...
              <div class="portlet-body">
                <div class="form-body">
                  ...
                  <div class="alert alert-success display-show">
                    ...
                    <span> <?php echo $RecursosCons->RecursosCons['ins']; ?> </span> </div>
                  <?php } ?>
                  <?php if($_GET["alt"]==1){ ?>
                  <div class="alert alert-success display-show">
                    <button class="close" data-close="alert"></button>
                  ...
                  <?php if($row_rsGal["id"] == 1) { ?>
                  <div class="form-group">
                    <label class="col-md-2 control-label" for="link"><?php echo $RecursosCons->RecursosCons['link_label']; ?>: </label>
                    <div class="col-md-6">
                        <textarea class="form-control" name="link" id="link"><?php echo stripslashes($row_rsP['link']); ?></textarea>
                    </div>
                  </div>
                  <?php } else { ?>
                  <div class="form-group">
                    <label class="col-md-2 control-label"><?php echo $RecursosCons->RecursosCons['img_galeria_tam_recomendado']; ?></label>
                    <div class="col-md-6">
                      <div class="fileinput fileinput-<?php if($row_rsP['imagem1']!="" && file_exists("../../../imgs/galerias/".$row_rsP['imagem1'])) { ?>exists<?php } else { ?>new<?php } ?>" data-provides="fileinput">
                        ...
                        <div class="fileinput-preview fileinput-exists thumbnail" style="max-width: 200px; max-height: 150px;">
                          <?php if($row_rsP['imagem1']!="" && file_exists("../../../imgs/galerias/".$row_rsP['imagem1'])) { ?>
                          <a href="../../../imgs/galerias/<?php echo $row_rsP['imagem1']; ?>" class="fancybox-button" data-rel="fancybox-button"><img src="../../../imgs/galerias/<?php echo $row_rsP['imagem1']; ?>"></a>
                          <?php } ?>
                        </div>
