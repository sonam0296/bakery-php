var ConteudoDados = function () {
    ...
    var nome_script = $('script[src*=galerias-conteudo]');
    ...
    var handleProducts = function() {
		...
		// ler valor passado por data-galeria
		var this_js_script = $('script[src*=galerias-conteudo-rpc]'); // or better regexp to get the file name..
		var id_galeria = this_js_script.attr('data-galeria'); 
        ...
        grid.init({
            ...
            dataTable: { // here you can define a typical datatable settings from http://datatables.net/usage/options 
                ...
                "ajax": {
                    "url": "galerias-conteudo-list.php?id_galeria="+id_galeria, // ajax source,
                },
		...
		$('#bt_submete').click( function() {
			...
			$.post("galerias-conteudo-rpc.php", {op:"ordenar_registos", campos:data}, function(data){
				window.location='galerias-conteudo.php?id='+id_galeria;
			});
			return false;
		} );
    }
