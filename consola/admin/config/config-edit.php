...
if((isset($_POST["MM_insert"])) && ($_POST["MM_insert"] == "alterar")) {
  ...
  if(isset($_POST['popup_ativo'])) $ativo=1;
	...
	$insertSQL = "UPDATE config SET manutencao=:manutencao, ips=:ips, link_popup=:link_popup, ativo=:ativo, tipo_popup=:tipo_popup, trans_time=:trans_time  WHERE id='1'";
  ...
  $rsInsert->bindParam(':trans_time', $_POST['trans_time'], PDO::PARAM_INT);
              ...
              <div class="portlet-body">
                <div class="form-body">
                  ...
                  <div class="form-group div_imagem">
                        <label class="col-md-2 control-label" for="trans_time"><?php echo $RecursosCons->RecursosCons['trans_time_label']; ?>: </label>
                      <div class="col-md-8">
                          <input type="text" class="form-control" name="trans_time" id="trans_time" value="<?php echo $row_rsP['trans_time']; ?>">
                          <p class="help-block">
                            e.g: 1000, 2000 etc. 1 second= 1000
                          </p>
                      </div>
                    </div>
