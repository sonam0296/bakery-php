...
if(isset($_GET['rem']) && $_GET['rem'] == 1) {
    ...
    while($row_rsLinguas = $rsLinguas->fetch()) {
      $query_rsDel = "DELETE FROM contactos_locais_".$row_rsLinguas['sufixo']." WHERE id=:id";
      $rsDel = DB::getInstance()->prepare($query_rsDel);
      $rsDel->bindParam(':id', $_GET['id'], PDO::PARAM_INT);  
      $rsDel->execute();
      DB::close();
    }
    ...
    alteraSessions('contactos');
		...
		header("Location: l_contactos.php?r=1");
	}
}
...
<div class="page-container">
  ...
  <div class="page-content-wrapper">
    <div class="page-content"> 
      <!-- BEGIN PAGE HEADER-->
      <h3 class="page-title"> <?php echo $RecursosCons->RecursosCons['contactos']; ?>  <small><?php echo $RecursosCons->RecursosCons['alterar_registo']; ?> </small> </h3>
      <div class="page-bar">
        <ul class="page-breadcrumb">
          ...
          <li> <a href="l_contactos.php"><?php echo $RecursosCons->RecursosCons['contactos_locais']; ?> </a></li>
        </ul>
      </div>
      <!-- END PAGE HEADER--> 
      <!-- BEGIN PAGE CONTENT-->
        ...
        <div class="col-md-12"> 
          ...
          <div class="portlet">
            <div class="portlet-title">
              <div class="caption"> <i class="fa fa-pencil-square"></i><?php echo $RecursosCons->RecursosCons['contactos_locais']; ?> </div>
              <div class="actions"> <a href="l_contactos-insert.php" class="btn default yellow-stripe"> <i class="fa fa-plus"></i> <span class="hidden-480"> <?php echo $RecursosCons->RecursosCons['novo_registo']; ?> </span> </a> </div>
            </div>
            <div class="tabbable">
              <ul class="nav nav-tabs">
                <li class="nav-tab"  onClick="window.location='contactos.php?id=<?php echo $id; ?>&tab_sel=1'"> <a href="#dados_pessoais" data-toggle="tab" onClick="document.getElementById('tab_sel').value='1'"> <?php echo $RecursosCons->RecursosCons['contactos_gerais']; ?> </a> </li>
                <li class="nav-tab active" onClick="window.location='l_contactos.php'"> <a href="javascript:void(null)" data-toggle="tab"> <?php echo $RecursosCons->RecursosCons['contactos_locais']; ?> </a> </li>
              </ul> 
            </div>
                ...
                <table class="table table-striped table-bordered table-hover" id="datatable_products">
                  <thead>
                    ...
                    <tr role="row" class="filter">
                      <td></td>
                      <td><input type="text" class="form-control form-filter input-sm"  name="form_titulo" onKeyPress="submete(event)"></td>
                      <td>&nbsp;</td>
                      <td><select name="form_footer" class="form-control form-filter input-sm" onchange="document.getElementById('pesquisa').click();">
...
<script src="l_contactos-list.js" data-texto1="<?php echo $RecursosCons->RecursosCons['a_carregar']; ?>" data-texto2="<?php echo $RecursosCons->RecursosCons['selec_opcao']; ?>" data-texto3="<?php echo $RecursosCons->RecursosCons['selec_registos']; ?>" ></script> 
