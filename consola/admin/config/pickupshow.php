...
if(isset($_GET['rem']) && $_GET['rem'] == 1) {
  if(isset($_GET['id']) && $_GET['id'] != "" && $_GET['id'] != 0) {
    ...
    while($row_rsLinguas = $rsLinguas->fetch()) {
      $query_rsP = "DELETE FROM events WHERE id = :id";
    ...
    header("Location: pickupshow.php?r=1");
  }
}

$query_rsCategorias = "SELECT id, title FROM events ORDER BY title ASC";
...
$query_rsMarcas = "SELECT id, title FROM events ORDER BY title ASC";
...
<div class="page-container">
  ...
  <div class="page-content-wrapper">
    <div class="page-content"> 
      <!-- BEGIN PAGE HEADER-->
      <h3 class="page-title">PickUp Date <small><?php echo $RecursosCons->RecursosCons['menu_listagem']; ?></small> </h3>
      <div class="page-bar">
        <ul class="page-breadcrumb">
          ...
          <li> <a href="pickupshow.php">PickUp Date </a> </li>
        </ul>
      </div>
      <!-- END PAGE HEADER--> 
      <!-- BEGIN PAGE CONTENT-->
        ...
        <div class="col-md-12"> 
          ...
          <div class="portlet">
            <div class="portlet-title">
              <div class="caption"> <i class="fa fa-pencil-square"></i>PickUp Date </div>
              <div class="actions"> <a href="pickupdate.php" class="btn default yellow-stripe"> <i class="fa fa-plus"></i> <span class="hidden-480"> <?php echo $RecursosCons->RecursosCons['novo_registo']; ?> </span> </a> </div>
            </div>
...
<script src="pickup-list.js" data-texto1="<?php echo $RecursosCons->RecursosCons['a_carregar']; ?>" data-texto2="<?php echo $RecursosCons->RecursosCons['selec_opcao']; ?>" data-texto3="<?php echo $RecursosCons->RecursosCons['selec_registos']; ?>"></script> 
