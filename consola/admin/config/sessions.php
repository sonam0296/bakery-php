...
<div class="page-container">
	...
	<div class="page-content-wrapper">
		<div class="page-content">
			<!-- BEGIN PAGE HEADER-->            
			<h3 class="page-title"><?php echo $RecursosCons->RecursosCons['sessions']; ?> <small><?php echo $RecursosCons->RecursosCons['gestao_sessions']; ?></small></h3>
			<div class="page-bar">
      ...
      <div id="alert_div" class="alert alert-success display-show">
        <button class="close" data-close="alert"></button>
        <span> <?php echo $RecursosCons->RecursosCons['sess_alt']; ?> </span> 
      </div>
			<div class="row">
				<div class="col-md-12">
					...
					<div class="portlet">
						<div class="portlet-title">
							<div class="caption">
								<i class="fa fa-code"></i><?php echo $RecursosCons->RecursosCons['sessions']; ?>
							</div>
							<div class="actions"> <a href="javascript:;" onClick="refreshSessions();" class="btn blue"> <i class="fa fa-refresh"></i> <span class="hidden-480"> <?php echo $RecursosCons->RecursosCons['refresh_sessions']; ?> </span> </a> </div>
						</div>
...
<script src="sessions-rpc.js" data-texto1="<?php echo $RecursosCons->RecursosCons['a_carregar']; ?>" data-texto2="<?php echo $RecursosCons->RecursosCons['selec_opcao']; ?>" data-texto3="<?php echo $RecursosCons->RecursosCons['selec_registos']; ?>"></script>
...
function refreshSessions() {
	$.post("sessions-rpc.php", {op:"refreshSessions"}, function(data) {
