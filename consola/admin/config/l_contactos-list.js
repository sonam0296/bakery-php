var List = function () {
    ...
    var nome_script = $('script[src*=l_contactos]');
    ...
    var handleProducts = function() {
        ...
        grid.init({
            ...
            dataTable: { // here you can define a typical datatable settings from http://datatables.net/usage/options 
                ...
                "ajax": {
                    "url": "l_contactos-list.php" // ajax source
                },
		...
		$('#bt_submete').click( function() {
			...
			$.post("l_contactos-rpc.php", {op:"ordenar_registos", campos:data}, function(data){
				window.location='l_contactos.php?peca='+id;
			});
			return false;
		} );
    }
