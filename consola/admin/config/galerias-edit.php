...
$query_rsP = "SELECT * FROM galerias".$extensao." WHERE id=:id";
...
if ((isset($_POST["MM_insert"])) && ($_POST["MM_insert"] == "galerias")) {
	...
	if($_POST['nome']) {
		...
		$insertSQL = "UPDATE galerias".$extensao." SET nome=:nome WHERE id=:id";
		...
		if(!$_FILES){ // apaga imagem
			...
			while($row_rsLinguas = $rsLinguas->fetch()) {
				...
				$insertSQL = "UPDATE galerias_".$row_rsLinguas["sufixo"]." SET imagem1=:imagem WHERE id=:id";
				$rsInsert = DB::getInstance()->prepare($insertSQL);
		...
		header("Location: galerias-edit.php?id=".$_GET['id']."&alt=1");
...
<div class="page-container">
  ...
  <div class="page-content-wrapper">
    <div class="page-content"> 
      <!-- BEGIN PAGE HEADER-->
      <h3 class="page-title"><?php echo $RecursosCons->RecursosCons['page_title_galerias']; ?> </h3>
      <div class="page-bar">
            ...
            <div class="portlet">
              <div class="portlet-title">
                ...
                <div class="form-actions actions btn-set">
                  <button type="button" name="back" class="btn default" onClick="document.location='galerias.php'"><i class="fa fa-angle-left"></i> <?php echo $RecursosCons->RecursosCons['voltar']; ?></button>
              ...
              <div class="portlet-body">
                <div class="form-body">
                  ...
                  <div class="form-group">
                    <label class="col-md-2 control-label"><?php echo $RecursosCons->RecursosCons['img_galeria_tam_remcomendado_2']; ?></label>
                    <div class="col-md-6">
