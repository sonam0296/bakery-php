...
if((isset($_POST["MM_insert"])) && ($_POST["MM_insert"] == "frm_tipos")) {
	...
	if($_POST['nome']!='') {
		$insertSQL = "UPDATE news_tipos".$extensao." SET nome=:nome WHERE id=:id";
...
$query_rsP = "SELECT * FROM news_tipos".$extensao." WHERE id=:id";
    ...
    <div class="page-content"> 
      ...
      <div class="page-bar">
        <ul class="page-breadcrumb">
          ...
          <li>
            <a href="tipos.php">Editar tipo</a>
          </li>
        </ul>
      </div>
      <!-- END PAGE HEADER-->      
        ...
        <div class="modal-dialog">
          <div class="modal-content">
            ...
            <div class="modal-footer">
              <button type="button" class="btn blue" onClick="document.location='tipos.php?rem=1&id=<?php echo $row_rsP["id"]; ?>'">Ok</button>
          ...
          <form id="frm_tipos" name="frm_tipos" class="form-horizontal form-row-seperated" method="post" role="form" enctype="multipart/form-data">
            ...
            <div class="portlet">
              <div class="portlet-title">
                <div class="caption"> <i class="fa fa-pencil-square"></i>Newsletter - Tipos - <?php echo $row_rsP['nome']; ?></div>
