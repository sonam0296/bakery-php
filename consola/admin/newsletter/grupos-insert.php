...
if((isset($_POST["MM_insert"])) && ($_POST["MM_insert"] == "frm_grupos")) {
	if($_POST['nome']!='') {
		...
		$insertSQL = "SELECT MAX(id) FROM news_grupos";
		...
		$insertSQL = "INSERT INTO news_grupos (id, nome) VALUES ('$max_id', :nome)";
		$rsInsert = DB::getInstance()->prepare($insertSQL);
		$rsInsert->bindParam(':nome', $_POST['nome'], PDO::PARAM_STR, 5);
		$rsInsert->execute();
		DB::close();

		header("Location: grupos.php?env=1");
	}
}
    ...
    <div class="page-content"> 
      ...
      <div class="page-bar">
        <ul class="page-breadcrumb">
          ...
          <li>
            <a href="grupos.php">Inserir tipo</a>
          </li>
        </ul>
      </div>
      <!-- END PAGE HEADER--> 
