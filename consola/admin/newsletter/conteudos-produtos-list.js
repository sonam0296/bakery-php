var ConteudoDados = function () {
    ...
    var handleProducts = function() {
		...
		var this_js_script = $('script[src*=conteudos-produtos-list]'); // or better regexp to get the file name..
		var id_tema = this_js_script.attr('data-tema'); 
        ...
        grid.init({
            ...
            dataTable: { // here you can define a typical datatable settings from http://datatables.net/usage/options 
                ...
                "ajax": {
                    "url": "conteudos-produtos-list.php?id_tema="+id_tema, // ajax source,
                },
		...
		$('#bt_submete').click( function() {
			...
			$.post("conteudos-produtos-rpc.php", {op:"ordenar_registos", campos:data}, function(data){
				window.location='conteudos-produtos.php?id='+id_tema;
			});
			return false;
		} );
    }
