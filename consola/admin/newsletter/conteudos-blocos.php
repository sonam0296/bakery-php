...
if(isset($_GET['rem']) && $_GET['rem'] == 1) {
    ...
    $query_rsDelete = "DELETE FROM news_temas WHERE id=:id";
    $rsDelete = DB::getInstance()->prepare($query_rsDelete);
    $rsDelete->bindParam(':id', $_GET['id'], PDO::PARAM_INT);
    $rsDelete->execute();
    DB::close();
		
		header("Location: conteudos-blocos.php?id=".$_GET['id_cont']."&r=1");
	}
}
...
<div class="page-container">
  ...
  <div class="page-content-wrapper">
    <div class="page-content"> 
      <!-- BEGIN PAGE HEADER-->
      <h3 class="page-title"> Newsletter » <?php echo $row_rsCont["nome"]; ?> » Blocos <small>Listagem</small> </h3>
      <div class="page-bar">
        ...
        <div class="col-md-12"> 
          ...
          <div class="portlet">
            <div class="portlet-title">
              <div class="caption"> <i class="fa fa-pencil-square"></i>Newsletter - <?php echo $row_rsCont["nome"]; ?> - Blocos </div>
              <div class="actions"> <a href="conteudos-blocos-insert.php?id=<?php echo $_GET['id']; ?>" class="btn default yellow-stripe"> <i class="fa fa-plus"></i> <span class="hidden-480"> Novo Registo </span> </a> </div>
            </div>
            <div class="portlet-body">
              <div class="tabbable">
                <ul class="nav nav-tabs">
                  <li > <a href="#tab_general" data-toggle="tab" onClick="document.location='conteudos-edit.php?id=<?php echo $_GET['id']; ?>'"> Detalhe </a> </li>
                  <li class="active"> <a href="#tab_blocos" data-toggle="tab"> Blocos </a> </li>
                </ul>
                <div class="tab-content no-space">
                  <div class="tab-pane active" id="tab_blocos">
                    <div class="table-container">
                      ...
                      <input type="hidden" name="id_conteudo" id="id_conteudo" value="<?php echo $_GET['id']; ?>">
                        <thead>
...
<script src="conteudos-blocos-list.js" data-cont="<?php echo $_GET['id']; ?>"></script> 
