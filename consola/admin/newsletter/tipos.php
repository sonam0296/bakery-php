...
if(isset($_GET['rem']) && $_GET['rem'] == 1) {
	if(isset($_GET['id']) && $_GET['id'] != "" && $_GET['id'] != 0) {
		...
		$query_rsP = "UPDATE newsletters SET tipo=0 WHERE tipo = :id";
		...
		while($row_rsLinguas = $rsLinguas->fetch()) {
			$query_rsP = "DELETE FROM news_tipos_".$row_rsLinguas['sufixo']." WHERE id = :id";
			$rsP = DB::getInstance()->prepare($query_rsP);
			$rsP->bindParam(':id', $id, PDO::PARAM_INT, 5);
			$rsP->execute();
			DB::close();
				...
				<div class="col-md-12">
					...
					<div class="portlet">
						<div class="portlet-title">
							<div class="caption">
								<i class="fa fa-pencil-square"></i>Newsletter - Tipos
							</div>
              <div class="actions"> <a href="tipos-insert.php" class="btn default yellow-stripe"> <i class="fa fa-plus"></i> <span class="hidden-480"> Novo Tipo </span> </a> </div>
            </div>
...
<script src="tipos-rpc.js"></script>
