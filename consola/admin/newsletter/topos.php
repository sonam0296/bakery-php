...
if(isset($_GET['rem']) && $_GET['rem'] == 1) {
    ...
    $query_rsDel = "UPDATE news_conteudo SET topo = 0 WHERE topo = :id";
    $rsDel = DB::getInstance()->prepare($query_rsDel);
    $rsDel->bindParam(':id', $id, PDO::PARAM_INT);  
    $rsDel->execute();
    DB::close();
		
		$query_rsP = "SELECT imagem1 FROM news_topos WHERE id = :id";
		...
		$query_rsDel = "DELETE FROM news_topos WHERE id=:id";
		$rsDel = DB::getInstance()->prepare($query_rsDel);
		$rsDel->bindParam(':id', $id, PDO::PARAM_INT);	
		$rsDel->execute();
		DB::close();
		
		header("Location: topos.php?r=1");
	}
}
...
<div class="page-container">
  ...
  <div class="page-content-wrapper">
    <div class="page-content"> 
      <!-- BEGIN PAGE HEADER-->
      <h3 class="page-title"> Newsletter <small>listagem dos topos</small> </h3>
      <div class="page-bar">
        <ul class="page-breadcrumb">
          <li> <i class="fa fa-home"></i> <a href="../index.php">Home</a> <i class="fa fa-angle-right"></i> </li>
          <li> <a href="javascript:void(null)">Newsletters</a> <i class="fa fa-angle-right"></i> </li>
          <li> <a href="topos.php">Topos</a> </li>
        </ul>
      </div>
      <!-- END PAGE HEADER--> 
      <!-- BEGIN PAGE CONTENT-->
      <div class="alert alert-danger display-<?php if(isset($_GET['r']) && $_GET['r']==1) echo "show"; else echo "hide"; ?>">
        ...
        <span> Registo eliminado com sucesso. </span> </div>
      <div class="alert alert-success display-<?php if(isset($_GET['alt']) && $_GET['alt']==1) echo "show"; else echo "hide"; ?>">
        <button class="close" data-close="alert"></button>
        <span> Registo alterado com sucesso. </span> </div>
      <div class="row">
        <div class="col-md-12"> 
          <!-- Begin: life time stats -->
          <div class="portlet">
            <div class="portlet-title">
              <div class="caption"> <i class="fa fa-pencil-square"></i>Newsletter - Topos </div>
              <div class="actions"> <a href="topos-insert.php" class="btn default yellow-stripe"> <i class="fa fa-plus"></i> <span class="hidden-480"> Novo Topo </span> </a> </div>
            </div>
            <div class="portlet-body">
              <div class="table-container">
                <div class="table-actions-wrapper"> <span> </span>
                  <select class="table-group-action-input form-control input-inline input-small input-sm">
                    <option value="">Selecione oper.</option>
...
<script src="topos-list.js"></script> 
