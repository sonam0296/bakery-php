...
if ((isset($_POST["MM_insert"])) && ($_POST["MM_insert"] == "frm_conteudo_produtos")) {
  $query_rsP = "SELECT * FROM news_produtos WHERE id=:id";
  ...
  $rsTema->bindParam(':id', $row_rsP['id_tema'], PDO::PARAM_INT);
  $rsTema->execute();
  ...
  DB::close();
    ...
    $insertSQL = "UPDATE news_produtos SET categoria_id=:categoria, produto_id=:produto, nome=:nome, ref=:ref, preco=:preco, preco_ant=:preco_ant, texto_botao=:texto_botao, descricao=:descricao, imagem1='".$row_rsProd["imagem2"]."', link=:link, novidade=:novidade WHERE id=:id";
    ...
    if(!$manter) 
      header("Location: conteudos-produtos.php?id=".$row_rsP["id_tema"]."&alt=1");
    else 
      header("Location: conteudos-produtos-edit.php?id=".$id."&alt=1");
	} 
    ...
    if($_POST['nome']!='') {
      ...
      if($tipo2 == 1 || $tipo2 == 3 || $tipo2 == 4) {
        ...
        if($tipo2 == 1 || $tipo2 == 3) {
          if($_FILES['img']['name']=='' && !$row_rsP['imagem1'])
            $erro = 1;
        }

        //Verificar se existe a imagem 2
        if($tipo2 == 4) {
          if($_FILES['img2']['name']=='' && !$row_rsP['imagem2'])
            $erro = 2;
        }
      ...
      if($erro == 0 && $erro2 == 0) {
        ...
        $insertSQL = "UPDATE news_produtos SET nome=:nome, titulo=:titulo, titulo2=:titulo2, descricao=:descricao, descricao2=:descricao2, tipo_link1=:tipo_link1, tipo_link2=:tipo_link2, link=:link, link2=:link2, texto_botao=:texto_botao, texto_botao2=:texto_botao2 WHERE id=:id";
        $rsInsert = DB::getInstance()->prepare($insertSQL);
        $rsInsert->bindParam(':id', $id, PDO::PARAM_INT); 
        ...
        if($_FILES['img']['name']!='') {
          ...
          $insertSQL = "UPDATE news_produtos SET imagem1=:imagem1 WHERE id=:id";
          $rsInsert = DB::getInstance()->prepare($insertSQL);
        ...
        if($_FILES['img2']['name']!='') {
          ...
          $insertSQL = "UPDATE news_produtos SET imagem2=:imagem2 WHERE id=:id";
          $rsInsert = DB::getInstance()->prepare($insertSQL);
      ...
      if($erro == 2)
        header("Location: conteudos-produtos-edit.php?id=".$id."&erro=3");
      else if($erro == 1)
        header("Location: conteudos-produtos-edit.php?id=".$id."&erro=2");
      else if($erro2 == 1)
        header("Location: conteudos-produtos-edit.php?id=".$id."&erro=1");
      else if(!$manter)
        header("Location: conteudos-produtos.php?id=".$row_rsP["id_tema"]."&alt=1");
      else
        header("Location: conteudos-produtos-edit.php?id=".$id."&alt=1");
...
<div class="page-container">
  ...
  <div class="page-content-wrapper">
    <div class="page-content"> 
      <!-- BEGIN PAGE HEADER-->
      <h3 class="page-title"> Newsletter » <?php echo $row_rsCont["nome"] ?> » Blocos » Conteudos <small>alterar registo</small> </h3>
      <div class="page-bar">
        <ul class="page-breadcrumb">
          ...
          <li> <a href="conteudos-produtos.php?id=<?php echo $row_rsTema['id']; ?>"><?php echo $row_rsTema["nome"] ?></a> <i class="fa fa-angle-right"></i> </li>
          <li> <a href="javascript:;"><?php echo $row_rsP["nome"] ?></a> </li>
        </ul>
      </div>
      <!-- END PAGE HEADER--> 
        ...
        <div class="modal-dialog">
          <div class="modal-content">
            ...
            <div class="modal-footer">
              <button type="button" class="btn blue" onClick="document.location='conteudos-produtos.php?rem=1&id=<?php echo $row_rsP["id"]; ?>&id_tema=<?php echo $row_rsTema["id"]; ?>'">Ok</button>
      ...
      <div class="row">
        <div class="col-md-12">
          <form id="frm_conteudo_produtos" name="frm_conteudo_produtos" class="form-horizontal form-row-seperated" method="post" role="form" enctype="multipart/form-data">
            ...
            <input type="hidden" name="tipo2" id="tipo2" value="<?php echo $row_rsP["tipo2"]; ?>">
            ...
            <div class="portlet">
              <div class="portlet-title">
                <div class="caption"> <i class="fa fa-pencil-square"></i>Newsletter - <?php echo $row_rsCont["nome"] ?> - Blocos - Conteudos - Editar registo</div>
                <div class="form-actions actions btn-set">
                  <button type="button" name="back" class="btn default" onClick="document.location='conteudos-produtos.php?id=<?php echo $row_rsTema['id']; ?>'"><i class="fa fa-angle-left"></i> Voltar</button>
                ...
                <div class="form-body">
                  ...
                  <?php if($row_rsTema["tipo"] == 1) { // produtos ?>
                        ...
                        <select class="form-control select2me" id="categoria" name="categoria" onChange="carregaProdutos(this.value);">
                          ...
                          <?php if($totalRows_rsCategorias > 0) { ?>
                            <?php while($row_rsCategorias = $rsCategorias->fetch()) { ?>
                              <option value="<?php echo $row_rsCategorias['id']; ?>" <?php if($row_rsCategorias['id'] == $row_rsP['categoria_id']) echo "selected"; ?>><?php echo $row_rsCategorias['nome']; ?></option>
                              <?php
                              ...
                              if($totalRows_rsCategorias2 > 0) {
                                while($row_rsCategorias2 = $rsCategorias2->fetch()) { ?>
                                  <option value="<?php echo $row_rsCategorias2['id']; ?>" <?php if($row_rsCategorias2['id'] == $row_rsP['categoria_id']) echo "selected"; ?>><?php echo $row_rsCategorias['nome']." » ".$row_rsCategorias2['nome']; ?></option>
                                <?php }
                              }
                            }
                          } ?>
                    ...
                    <div class="form-group">
                      ...
                      <div class="col-md-8">
                        <input type="text" class="form-control" name="nome_produto" id="nome_produto" value="<?php echo $row_rsP['nome']; ?>" data-required="1">
                      </div>
                    </div>
                    <div class="form-group">
                    ...
                    <div id="div_outlet_prom" class="form-group">
                      ...
                      <div class="col-md-3">
                        <div class="input-group">
                          <input type="text" class="form-control" name="preco" id="preco" value="<?php echo $row_rsP['preco']; ?>">
                          <span class="input-group-addon">€</span> </div>
                      </div>
                      <label class="col-md-2 control-label" for="preco_ant">Preço ant.: </label>
                      <div class="col-md-3">
                        <div class="input-group">
                          <input type="text" class="form-control" name="preco_ant" id="preco_ant" value="<?php echo $row_rsP['preco_ant']; ?>">
                          <span class="input-group-addon">€</span> </div>
                      </div>
                    </div>
                    <div class="form-group">
                    ...
                    <div class="form-group">
                      ...
                      <div class="col-md-8">
                        <input type="text" class="form-control" name="link_produto" id="link_produto" value="<?php echo $row_rsP['link']; ?>" readonly>
                      </div>
                    </div>
                    <div class="form-group">
                      <label class="col-md-2 control-label" for="novidade">É Novidade? </label>
                      <div class="col-md-8" style="padding-top: 8px;">
                        <input type="checkbox" class="form-control" name="novidade" id="novidade" value="1" <?php if($row_rsP['novidade'] == 1) echo "checked"; ?>/>
                      </div>
                    </div>
                  <?php } else { // texto e/ou imagem ?>
                        ...
                        <div class="form-group">
                          ...
                          <div class="col-md-9" style="padding-top: 8px">
                            <strong style="font-size: 14px">
                              <?php if($row_rsP['tipo2'] == 1) {
                                echo "Texto e Imagem"; 
                              } else if($row_rsP['tipo2'] == 2) {
                                echo "Texto"; 
                              } else if($row_rsP['tipo2'] == 3) {
                                echo "Imagem"; 
                              } else if($row_rsP['tipo2'] == 4) {
                                echo "2 Textos/Imagens"; 
                              } else if($row_rsP['tipo2'] == 5) {
                                echo "2 Imagens"; 
                              } else if($row_rsP['tipo2'] == 6) {
                                echo "Botão"; 
                              } ?>
                            </strong>
                          </div>
                    ...
                    <div class="row">
                      <div class="col-md-7">
                        ...
                        <div class="form-group">
                          ...
                          <div class="col-md-8">
                            <div class="md-radio-inline">
                              <div class="md-radio">
                                <input type="radio" id="tipo_link1_1" name="tipo_link" class="md-radiobtn" value="1" <?php if($row_rsP['tipo_link1'] == 1) echo "checked"; ?>>
                                <label for="tipo_link1_1"> <span></span> <span class="check"></span> <span class="box"></span> URL </label>
                              </div>
                              <div class="md-radio">
                                <input type="radio" id="tipo_link1_2" name="tipo_link" class="md-radiobtn" value="2" <?php if($row_rsP['tipo_link1'] == 2) echo "checked"; ?>>
                        ...
                        <div class="form-group">
                          <label class="col-md-3 control-label" for="link_1" id="link_1_label"><?php if($row_rsP['tipo_link1'] == 1) echo "Link:"; else if($row_rsP['tipo_link1'] == 2) echo "Email:"; ?></label>
                          <div class="col-md-8">
                            <input type="text" class="form-control" name="link_1" id="link_1" value="<?php echo $row_rsP['link']; ?>">
                          </div>
                        </div>
                        <div id="div_texto_link_1" class="form-group">
                          <label class="col-md-3 control-label" for="texto_link_1">Texto Botão: </label>
                          <div class="col-md-8">
                            <input type="text" class="form-control" name="texto_link_1" id="texto_link_1" value="<?php echo $row_rsP['texto_botao']; ?>">
                          </div>
                        </div>
                            ...
                            <div class="fileinput fileinput-<?php if($row_rsP['imagem1']!="" && file_exists("../../../imgs/imgs_news/produtos/".$row_rsP['imagem1'])) { ?>exists<?php } else { ?>new<?php } ?>" data-provides="fileinput">
                              ...
                              <div class="fileinput-preview fileinput-exists thumbnail" style="max-width: 200px; max-height: 150px;">
                                <?php if($row_rsP['imagem1']!="" && file_exists("../../../imgs/imgs_news/produtos/".$row_rsP['imagem1'])) { ?>
                                  <a href="../../../imgs/imgs_news/produtos/<?php echo $row_rsP['imagem1']; ?>" data-fancybox="gallery"><img src="../../../imgs/imgs_news/produtos/<?php echo $row_rsP['imagem1']; ?>"></a>
                                <?php } ?>
                              </div>
                        ...
                        <div class="col-md-7">
                          ...
                          <div class="form-group">
                            ...
                            <div class="col-md-8">
                              <div class="md-radio-inline">
                                <div class="md-radio">
                                  <input type="radio" id="tipo_link2_1" name="tipo_link2" class="md-radiobtn" value="1" <?php if($row_rsP['tipo_link2'] == 1) echo "checked"; ?>>
                                  <label for="tipo_link2_1"> <span></span> <span class="check"></span> <span class="box"></span> URL </label>
                                </div>
                                <div class="md-radio">
                                  <input type="radio" id="tipo_link2_2" name="tipo_link2" class="md-radiobtn" value="2" <?php if($row_rsP['tipo_link2'] == 2) echo "checked"; ?>>
                          ...
                          <div class="form-group">
                            <label class="col-md-3 control-label" for="link_2" id="link_2_label"><?php if($row_rsP['tipo_link2'] == 1) echo "Link 2:"; else if($row_rsP['tipo_link2'] == 2) echo "Email 2:"; ?></label>
                            <div class="col-md-8">
                              <input type="text" class="form-control" name="link_2" id="link_2" value="<?php echo $row_rsP['link2']; ?>">
                            </div>
                          </div>
                          <div id="div_texto_link_2" class="form-group">
                            <label class="col-md-3 control-label" for="texto_link_2">Texto Botão 2: </label>
                            <div class="col-md-8">
                              <input type="text" class="form-control" name="texto_link_2" id="texto_link_2" value="<?php echo $row_rsP['texto_botao2']; ?>">
                            </div>
                          </div>
                              ...
                              <div class="fileinput fileinput-<?php if($row_rsP['imagem2']!="" && file_exists("../../../imgs/imgs_news/produtos/".$row_rsP['imagem2'])) { ?>exists<?php } else { ?>new<?php } ?>" data-provides="fileinput">
                                ...
                                <div class="fileinput-preview fileinput-exists thumbnail" style="max-width: 200px; max-height: 150px;">
                                  <?php if($row_rsP['imagem2']!="" && file_exists("../../../imgs/imgs_news/produtos/".$row_rsP['imagem2'])) { ?>
                                    <a href="../../../imgs/imgs_news/produtos/<?php echo $row_rsP['imagem2']; ?>" data-fancybox="gallery"><img src="../../../imgs/imgs_news/produtos/<?php echo $row_rsP['imagem2']; ?>"></a>
                                  <?php } ?>
                                </div>
                                <div> <span class="btn default btn-file"> <span class="fileinput-new"> Selecionar Imagem</span> <span class="fileinput-exists"> Alterar </span>
...
jQuery(document).ready(function() {    
  ...
  <?php if($row_rsTema["tipo"] == 1 && $row_rsP['categoria_id'] > 0) { ?>
    carregaProdutos('<?php echo $row_rsP['categoria_id']; ?>');
  <?php } ?>
});
</script>
<?php if($row_rsTema["tipo"] == 1) { // produtos ?>
...
function carregaProdutos(cat) {
  $.post("conteudos-produtos-rpc.php", {op: "carregaProdutos", cat: cat, id: '<?php echo $row_rsP['produto_id']; ?>'}, function(data) {
