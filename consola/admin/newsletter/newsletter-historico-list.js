var ConteudoDados = function () {
    ...
    var handleProducts = function() {
		...
		// ler valor passado por data-news
		var this_js_script = $('script[src*=newsletter-historico-list]'); // or better regexp to get the file name..
		var id_news = this_js_script.attr('data-news'); 
        ...
        grid.init({
            ...
            dataTable: { // here you can define a typical datatable settings from http://datatables.net/usage/options 
                ...
                "ajax": {
                    "url": "newsletter-historico-list.php?id_news="+id_news, // ajax source,
                },
