...
if((isset($_POST["MM_insert"])) && ($_POST["MM_insert"] == "frm_noticias")) {
	if($_POST['roll_name']!='') {
		$insertSQL = "SELECT MAX(id) FROM roll";
    ...
    $totalRows_rsLinguas = $rsLinguas->rowCount();
		...
		while($row_rsLinguas = $rsLinguas->fetch()) {
			...
			$nome=strtolower(verifica_nome($_POST['roll_name']));
			
			$query_rsProc = "SELECT id FROM roll WHERE roll_name like :nome";
      ...
      $rsProc->bindParam(':nome', $nome, PDO::PARAM_STR, 5);
			...
			$insertSQL = "INSERT INTO roll ( roll_name) VALUES (:nome)";
			$rsInsert = DB::getInstance()->prepare($insertSQL);
      ...
      $insertSQL = "ALTER TABLE l_pecas_en  ADD COLUMN product_qulity_$nome VARCHAR(255) NOT NULL DEFAULT '0' AFTER `stock`, ADD COLUMN selling_price_$nome VARCHAR(255) NOT NULL DEFAULT '0' AFTER `stock`,ADD COLUMN reguler_price_$nome VARCHAR(255) NOT NULL DEFAULT '0' AFTER `stock`, ADD COLUMN role_$nome VARCHAR(255) NOT NULL DEFAULT '0' AFTER `stock`;";
      $rsInsert = DB::getInstance()->prepare($insertSQL);
      $rsInsert->execute();
    ...
    alteraSessions('supplier');
		...
		header("Location: roll-edit.php?id=".$id."&env=1");
	}
}
...
<div class="page-container">
  ...
  <div class="page-content-wrapper">
    <div class="page-content"> 
      <!-- BEGIN PAGE HEADER-->
      <h3 class="page-title"> Roll <small><?php echo $RecursosCons->RecursosCons['inserir_registo']; ?></small> </h3>
      <div class="page-bar">
              ...
              <div class="portlet-body">
                <div class="form-body">
                  ...
                  <div class="form-group">
                    <label class="col-md-2 control-label" for="roll_name"><?php echo $RecursosCons->RecursosCons['titulo_label']; ?>: <span class="required"> * </span> </label>
                    <div class="col-md-8">
                      <input type="text" class="form-control" name="roll_name" id="roll_name" value="<?php echo $_POST['roll_name']; ?>" data-required="1">
                    </div>
                  </div>
