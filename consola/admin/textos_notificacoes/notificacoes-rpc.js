var ConteudoDados = function () {
    ...
    var nome_script = $('script[src*=notificacoes]');
    ...
    var handleProducts = function() {
        ...
        grid.init({
            ...
            dataTable: { // here you can define a typical datatable settings from http://datatables.net/usage/options 
                ...
                "ajax": {
                    "url": "notificacoes-list.php", // ajax source,
                },
		...
		// 	$.post("destaques-rpc.php", {op:"ordenar_registos", campos:data}, function(data){
		// 		window.location='destaques.php';
		// 	});
		// 	return false;
		// } );
    }
