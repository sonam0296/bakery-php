...
if(isset($_GET['rem']) && $_GET['rem'] == 1) {
    ...
    while($row_rsLinguas = $rsLinguas->fetch()) {
      $query_rsP = "SELECT imagem1, imagem2 FROM destaques_".$row_rsLinguas['sufixo']." WHERE id = :id";
      ...
      $query_rsDel = "DELETE FROM destaques_".$row_rsLinguas['sufixo']." WHERE id=:id";
    ...
    DB::close();
		...
		header("Location: destaques.php?r=1");
	}
}
...
<div class="page-container">
  ...
  <div class="page-content-wrapper">
    <div class="page-content"> 
      <!-- BEGIN PAGE HEADER-->
      <h3 class="page-title"> <?php echo $RecursosCons->RecursosCons['destaques']; ?>  <small><?php echo $RecursosCons->RecursosCons['listagem']; ?> </small> </h3>
      <div class="page-bar">
        <ul class="page-breadcrumb">
          <li> <i class="fa fa-home"></i> <a href="../index.php"><?php echo $RecursosCons->RecursosCons['home']; ?> </a> <i class="fa fa-angle-right"></i> </li>
          <li> <a href="destaques.php"><?php echo $RecursosCons->RecursosCons['destaques']; ?> </a> </li>
        </ul>
      </div>
      <!-- END PAGE HEADER--> 
      <!-- BEGIN PAGE CONTENT-->
        ...
        <div class="col-md-12"> 
          ...
          <div class="portlet">
            <div class="portlet-title">
              <div class="caption"> <i class="fa fa-pencil-square"></i><?php echo $RecursosCons->RecursosCons['destaques']; ?>  </div>
              <div class="actions"> <a href="destaques-insert.php" class="btn default yellow-stripe"> <i class="fa fa-plus"></i> <span class="hidden-480"><?php echo $RecursosCons->RecursosCons['novo_destaque']; ?>  </span> </a> </div>
            </div>
                ...
                <table class="table table-striped table-bordered table-hover" id="datatable_products">
                  <thead>
                    <tr role="row" class="heading">
                      ...
                      <th width="10%"> <?php echo $RecursosCons->RecursosCons['destacado']; ?> </th>
                    ...
                    <tr role="row" class="filter">
                      ...
                      <td>&nbsp;</td>
                      <td>&nbsp;</td>
                      <td><select name="form_destacado" class="form-control form-filter input-sm" onchange="document.getElementById('pesquisa').click();">
...
<script src="destaques-list.js" data-texto1="<?php echo $RecursosCons->RecursosCons['a_carregar']; ?>" data-texto2="<?php echo $RecursosCons->RecursosCons['selec_opcao']; ?>" data-texto3="<?php echo $RecursosCons->RecursosCons['selec_registos']; ?>" ></script> 
