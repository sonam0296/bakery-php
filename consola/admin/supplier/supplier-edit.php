...
if((isset($_POST["MM_insert"])) && ($_POST["MM_insert"] == "frm_noticias")) {
    ...
    if(isset($_POST['atualizar_url'])) {
      ...
      $nome_url = $row_rsP['url'];
		...
		// actualiza detalhes
		$insertSQL = "UPDATE supplier SET title=:nome, data=:data, product_order_number=:product_order_number, product_account_number=:product_account_number, s_email_id=:s_email_id, s_address=:supplier_address WHERE id=:id";
		...
		if(!$manter) 
			...
			header("Location: supplier-edit.php?id=".$id."&alt=1&tab_sel=1");
	}
...
$query_rsP = "SELECT * FROM supplier WHERE id = :id";
$rsP = DB::getInstance()->prepare($query_rsP);
...
<div class="page-container">
  ...
  <div class="page-content-wrapper">
    <div class="page-content"> 
      <!-- BEGIN PAGE HEADER-->
      <h3 class="page-title"> Supplier <small><?php echo $RecursosCons->RecursosCons['editar_registo']; ?></small> </h3>
      <div class="page-bar">
        ...
        <div class="modal-dialog">
          <div class="modal-content">
            ...
            <div class="modal-footer">
              <button type="button" class="btn blue" onClick="document.location='Supplier.php?rem=1&id=<?php echo $row_rsP["id"]; ?>'"><?php echo $RecursosCons->RecursosCons['txt_ok']; ?> </button>
	                  ...
	                  <div class="tab-pane <?php if($tab_sel==1) echo "active"; ?>" id="tab_general">
	                    <div class="form-body">
	                      ...
	                      <div class="form-group">
	                        <label class="col-md-2 control-label" for="data"><?php echo $RecursosCons->RecursosCons['data_label']; ?>: </label>
	                        <div class="col-md-3">
	                          <div class="input-group date date-picker" data-date-format="yyyy-mm-dd">
	                            <input type="text" class="form-control form-filter input-sm" name="data" placeholder="Data" id="data" value="<?php echo $row_rsP['data']; ?>" data-required="1">
	                    ...
	                    <div class="col-md-8">
	                      <input type="text" class="form-control" name="nome" id="nome" value="<?php echo $row_rsP['title']; ?>" data-required="1">
	                    </div>
	                  </div>
	                  <div class="form-group">
	                    <label class="col-md-2 control-label" for="product_order_number">Product Order Number: <span class="required"> * </span></label>
	                    <div class="col-md-8">
	                     <input type="text" class="form-control" name="product_order_number" id="product_order_number" value="<?php echo $row_rsP['product_order_number']; ?>" data-required="1">
	                    </div>
	                  </div>
	                  <div class="form-group">
	                    <label class="col-md-2 control-label" for="product_account_number">Product Account Number: <span class="required"> * </span></label>
	                    <div class="col-md-8">
	                     <input type="text" class="form-control" name="product_account_number" id="product_account_number" value="<?php echo $row_rsP['product_account_number']; ?>" data-required="1">
	                    </div>
	                  </div>
	                  <div class="form-group">
	                    <label class="col-md-2 control-label" for="s_email_id">Supplier Email Id: <span class="required"> * </span></label>
	                    <div class="col-md-8">
	                     <input type="text" class="form-control" name="s_email_id" id="s_email_id" value="<?php echo $row_rsP['s_email_id']; ?>" data-required="1">
	                    </div>
	                  </div>
	                  <div class="form-group">
	                    <label class="col-md-2 control-label" for="supplier_address">Supplier Address: <span class="required"> * </span> </label>
	                    <div class="col-md-8">
	                      <textarea class="form-control" id="supplier_address" name="supplier_address"><?php echo $row_rsP['s_address']; ?></textarea>
	                    </div>
	                  </div>
	              </div>
	          </div>
