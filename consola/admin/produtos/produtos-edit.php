...
if((isset($_POST["MM_insert"])) && ($_POST["MM_insert"] == "produtos_form")) {
  ...
  if($_POST['nome'] != '' && ($_POST['categoria'] != '' || CATEGORIAS == 2) && $tab_sel == 1) {
    ...
    if($_POST['nao_limitar_stock'] == 1) $nao_limitar_stock = 1;
      ...
      /* Start || Update Roll Value */
			...
			$insertSQL = "UPDATE l_pecas".$extensao." SET ref=:ref, categoria=:categoria, preco=:preco, preco_forn=:preco_forn, preco_ant=:preco_ant,markup=:markup, iva=:iva, peso=:peso, stock=:stock, prepare= :prepare, enquiry_type= :enquiry_type,message_text= :message_text, maxstock=:maxstock, nao_limitar_stock=:nao_limitar_stock WHERE id=:id";
			$rsInsert = DB::getInstance()->prepare($insertSQL);
      ...
      $rsInsert->bindParam(':message_text', $_POST['message_text'], PDO::PARAM_INT); 
  ...
  if($tab_sel==5) {
    ...
    while($row_rsLinguas = $rsLinguas->fetch()) {
      $insertSQL = "UPDATE l_pecas_en SET promocao_pagina=:promocao_pagina, promocao=:promocao, promocao_desconto=:promocao_desconto, promocao_datai=:promocao_datai, promocao_dataf=:promocao_dataf WHERE id=:id";
      $rsInsert = DB::getInstance()->prepare($insertSQL);
...
$query_rsPaginas = "SELECT id, nome FROM paginas_en ORDER BY nome ASC";
                  ...
                  <div class="tab-content no-space">
                    <div class="tab-pane <?php if($tab_sel==1) echo "active"; ?>" id="tab_general">
                      <div class="form-body">
                        ...
                        <div class="form-group">
                          <label class="col-md-2 control-label" for="stock"><?php echo $RecursosCons->RecursosCons['prepration_label']; ?>Prepare Time:</label>
                          <div class="col-md-3">
                            <div class="input-group">
                        ...
                        <div class="form-group">
                          <label class="col-md-2 control-label" for="message_text">Message Visible:</label>
                          <div class="col-md-3">
                            <div class="input-group">
                              <input type="checkbox" id="message_text" name="message_text" value="1" <?php if($row_rsP["message_text"] == 1) { echo  "checked"; } ?>>
                            </div>                    
                          </div>
                        </div>
                        ...
                        <!-- <div class="form-group">
                          <label class="col-md-2 control-label" for="short_descricao"><?php echo $RecursosCons->RecursosCons['descricao3_label']; ?>: </label>
                          <div class="col-md-8">
                            <textarea class="form-control caixa_options" id="short_descricao" name="short_descricao"><?php echo $row_rsP['short_descricao']; ?></textarea>
                          </div>
                        </div> -->   
