...
if(isset($_GET['rem']) && $_GET['rem'] == 1) {
    ...
    $query_rsP = "DELETE FROM l_pecas_relacao WHERE id_peca = :id";
		...
		while($row_rsLinguas = $rsLinguas->fetch()) {
			$query_rsP = "DELETE FROM l_pecas_en WHERE id = :id";
			$rsP = DB::getInstance()->prepare($query_rsP);
			$rsP->bindParam(':id', $id, PDO::PARAM_INT);
			$rsP->execute();
		}
...
$query_rsMarcas = "SELECT id, nome FROM l_marcas_en ORDER BY nome ASC";
              ...
              <div class="actions">
                  ...
                  <td></td>
               	...
               	<td><select name="form_destaque" class="form-control form-filter input-sm" onchange="document.getElementById('pesquisa').click();">
                        ...
                        <option value="0">Not HightLight</option>
                  </select></td>
    ...
    <div class="modal-content">
      <div class="modal-header">
        ...
        <button type="button" class="close" data-dismiss="modal" aria-label="Close">
     	...
     	<form action="update-brand.php" method="POST" id="import_products" role="form" enctype="multipart/form-data" class="form-horizontal">
