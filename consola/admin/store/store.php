...
if(isset($_GET['rem']) && $_GET['rem'] == 1) {
	if(isset($_GET['id']) && $_GET['id'] != "" && $_GET['id'] != 0) {
		...
		while($row_rsLinguas = $rsLinguas->fetch()) {
			$query_rsProc = "SELECT * FROM store_locater WHERE id = :id";
			...
			if($totalRows_rsProc > 0) {
				while($row_rsProc = $rsProc->fetch()) {
					$insertSQL = "UPDATE store_locater SET cat_mae='0' WHERE cat_mae=:cat_mae";
...
<div class="page-container">
	...
	<div class="page-content-wrapper">
		<div class="page-content">
			<!-- BEGIN PAGE HEADER-->      
  		<h3 class="page-title"> Store  <small> <?php echo $RecursosCons->RecursosCons['listagem']; ?></small> </h3>
			<div class="page-bar">
				...
				<div class="col-md-12">
					...
					<div class="portlet">
						<div class="portlet-title">
							<div class="caption">
								<i class="fa fa-folder"></i>Store
							</div>
              <div class="actions"> <a href="store-insert.php" class="btn default yellow-stripe"> <i class="fa fa-plus"></i> <span class="hidden-480"> New Store </span> </a> </div>
            </div>
...
<script src="store-rpc.js" data-texto1="<?php echo $RecursosCons->RecursosCons['a_carregar']; ?>" data-texto2="<?php echo $RecursosCons->RecursosCons['selec_opcao']; ?>" data-texto3="<?php echo $RecursosCons->RecursosCons['selec_registos']; ?>"></script>
