...
if(isset($_GET['rem']) && $_GET['rem'] == 1) {
    ...
    $totalRows_rsLinguas = $rsLinguas->rowCount();
      ...
      $query_rsP = "SELECT imagem1 FROM banners_popups_".$row_rsLinguas["sufixo"]." WHERE id = :id";
      ...
      @unlink("../../../imgs/banners/".$row_rsP['imagem1']);
			...
			$query_rsDel = "DELETE FROM banners_popups_".$row_rsLinguas["sufixo"]." WHERE id=:id";
    ...
    alteraSessions('banners');
		...
		header("Location: slideshow-popups.php?r=1");
	}
}
...
<div class="page-container">
  ...
  <div class="page-content-wrapper">
    <div class="page-content"> 
      <!-- BEGIN PAGE HEADER-->
      <h3 class="page-title"> <?php echo $RecursosCons->RecursosCons['banner_popups_title']; ?> <small><?php echo $RecursosCons->RecursosCons['listagem']; ?></small> </h3>
      <div class="page-bar">
        <ul class="page-breadcrumb">
          <li> <i class="fa fa-home"></i> <a href="../index.php"><?php echo $RecursosCons->RecursosCons['home']; ?></a> <i class="fa fa-angle-right"></i> </li>
          <li> <a href="slideshow-popups.php"><?php echo $RecursosCons->RecursosCons['banner_popups_title']; ?></a> </li>
        </ul>
      </div>
      <!-- END PAGE HEADER--> 
      <!-- BEGIN PAGE CONTENT-->
      ...
      <div class="alert alert-success display-<?php if(isset($_GET['ins']) && $_GET['ins']==1) echo "show"; else echo "hide"; ?>">
        <button class="close" data-close="alert"></button>
        ...
        <div class="col-md-12"> 
          ...
          <div class="portlet">
            <div class="portlet-title">
              <div class="caption"> <i class="fa fa-pencil-square"></i><?php echo $RecursosCons->RecursosCons['banner_popups_title']; ?> </div>
              <div class="actions"> <a href="slideshow-popups-insert.php" class="btn default yellow-stripe"> <i class="fa fa-plus"></i> <span class="hidden-480"> <?php echo $RecursosCons->RecursosCons['novo_banner']; ?> </span> </a> </div>
            </div>
              ...
              <div class="table-container">
                <div class="table-actions-wrapper"> <span> </span>
                  <select class="table-group-action-input form-control input-inline input-small input-sm">
                    ...
                    <option value="1"><?php echo $RecursosCons->RecursosCons['visivel']; ?></option>
                    <option value="2"><?php echo $RecursosCons->RecursosCons['nao_visivel']; ?></option>
                ...
                <table class="table table-striped table-bordered table-hover" id="datatable_products">
                  <thead>
                    <tr role="row" class="heading">
                      ...
                      <th width="10%"> <?php echo $RecursosCons->RecursosCons['tipo_cliente']; ?> </th>
                      <th width="10%"> <?php echo $RecursosCons->RecursosCons['clientes']; ?> </th>
                      <th width="10%"> <?php echo $RecursosCons->RecursosCons['inicio']; ?> </th>
                      <th width="10%"> <?php echo $RecursosCons->RecursosCons['fim']; ?> </th>
                      <th width="6%"> <?php echo $RecursosCons->RecursosCons['ordem']; ?> </th>
                      <th width="6%"> <?php echo $RecursosCons->RecursosCons['visivel_tab']; ?> </th>
                    ...
                    <tr role="row" class="filter">
                      ...
                      <td>&nbsp;</td>
                      <td><select name="form_tipo_cliente" class="form-control form-filter input-sm" onchange="document.getElementById('pesquisa').click();">
                          ...
                          <option value="3"><?php echo $RecursosCons->RecursosCons['ambos_label']; ?></option>
                        </select>
                      </td>
                      <td><select name="form_cliente_registo" class="form-control form-filter input-sm" onchange="document.getElementById('pesquisa').click();">
                          <option value=""><?php echo $RecursosCons->RecursosCons['pesq_todas']; ?></option>
                          <option value="1"><?php echo $RecursosCons->RecursosCons['com_registo_label']; ?></option>
                          <option value="2"><?php echo $RecursosCons->RecursosCons['sem_registo_label']; ?></option>
                          <option value="3"><?php echo $RecursosCons->RecursosCons['ambos_label']; ?></option>
                        </select>
                      </td>
                      <td>
                      	<div class="input-group date date-picker margin-bottom-5" data-date-format="yyyy-mm-dd">
                          <input type="text" class="form-control form-filter input-sm" readonly name="form_inicio" placeholder="Selecione">
                      ...
                      <td>
                      	<div class="input-group date date-picker margin-bottom-5" data-date-format="yyyy-mm-dd">
                          <input type="text" class="form-control form-filter input-sm" readonly name="form_fim" placeholder="Selecione">
                          <span class="input-group-btn">
                          <button class="btn btn-sm default" type="button"><i class="fa fa-calendar"></i></button>
                          </span>
                        </div></td>
...
<script src="slideshow-popups-list.js" data-texto1="<?php echo $RecursosCons->RecursosCons['a_carregar']; ?>" data-texto2="<?php echo $RecursosCons->RecursosCons['selec_opcao']; ?>" data-texto3="<?php echo $RecursosCons->RecursosCons['selec_registos']; ?>"></script> 
