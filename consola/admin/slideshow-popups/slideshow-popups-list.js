var List = function () {
    ...
    var nome_script = $('script[src*=slideshow-popups]');
    ...
    var handleProducts = function() {
        ...
        grid.init({
            ...
            dataTable: { // here you can define a typical datatable settings from http://datatables.net/usage/options 
                ...
                "ajax": {
                    "url": "slideshow-popups-list.php" // ajax source
                },
		...
		$('#bt_submete').click( function() {
			...
			$.post("slideshow-popups-rpc.php", {op:"ordenar_registos", campos:data}, function(data){
				window.location='slideshow-popups.php';
			});
			return false;
		} );
    }
