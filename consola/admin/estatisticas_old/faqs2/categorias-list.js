var List = function () {
    ...
    var nome_script = $('script[src*=categorias]');
    ...
    var handleProducts = function() {
        ...
        grid.init({
            ...
            dataTable: { // here you can define a typical datatable settings from http://datatables.net/usage/options 
                ...
                "ajax": {
                    "url": "categorias-list.php" // ajax source
                },
					...
					oControls.each(function() {
						...
						$.each(oData, function(index, value) {
							if ( index == oControl.attr('name') ) {
								...
								if(type == "SELECT") oControl.select2().select2('val',value);
							}
						});
					});
					return true;
		...
		$('#bt_submete').click( function() {
			...
			$.post("categorias-rpc.php", {op:"ordenar_registos", campos:data}, function(data){
