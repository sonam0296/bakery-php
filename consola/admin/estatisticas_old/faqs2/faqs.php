...
if(isset($_GET['rem']) && $_GET['rem'] == 1) {
    ...
    $totalRows_rsLinguas = $rsLinguas->rowCount();
		...
		while($row_rsLinguas = $rsLinguas->fetch()) {
			$query_rsDel = "DELETE FROM faqs2_".$row_rsLinguas["sufixo"]." WHERE id=:id";
		...
		header("Location: faqs.php?r=1");
	}
}

$query_rsCats = "SELECT * FROM faqs2_categorias_pt WHERE visivel = '1' ORDER BY nome ASC";
...
<div class="page-container">
  ...
  <div class="page-content-wrapper">
    <div class="page-content"> 
      <!-- BEGIN PAGE HEADER-->
      <h3 class="page-title"> <?php echo $RecursosCons->RecursosCons['faqs']; ?> <small><?php echo $RecursosCons->RecursosCons['listagem']; ?></small> </h3>
      <div class="page-bar">
        <ul class="page-breadcrumb">
          <li> <i class="fa fa-home"></i> <a href="../index.php"><?php echo $RecursosCons->RecursosCons['home']; ?></a> <i class="fa fa-angle-right"></i> </li>
          <li> <a href="faqs.php"><?php echo $RecursosCons->RecursosCons['faqs']; ?> <i class="fa fa-angle-right"></i> </a></li>
          <li> <a href="javascript:"><?php echo $RecursosCons->RecursosCons['listagem']; ?></a> </li>
        </ul>
      </div>
      <!-- END PAGE HEADER--> 
      <!-- BEGIN PAGE CONTENT-->
        ...
        <div class="col-md-12"> 
          ...
          <div class="portlet">
            <div class="portlet-title">
              <div class="caption"> <i class="fa fa-pencil-square"></i><?php echo $RecursosCons->RecursosCons['faqs']; ?> </div>
              <div class="actions"> <a href="faqs-insert.php" class="btn default yellow-stripe"> <i class="fa fa-plus"></i> <span class="hidden-480"> <?php echo $RecursosCons->RecursosCons['novo_registo']; ?> </span> </a> </div>
            </div>
              ...
              <div class="table-container">
                <div class="table-actions-wrapper"> <span> </span>
                  <select class="table-group-action-input form-control input-inline input-small input-sm">
                    ...
                    <option value="3"><?php echo $RecursosCons->RecursosCons['visiveis']; ?></option>
                    <option value="4"><?php echo $RecursosCons->RecursosCons['nao_visiveis']; ?></option>
                ...
                <table class="table table-striped table-bordered table-hover" id="datatable_products">
                  <thead>
                    <tr role="row" class="heading">
                      ...
                      <th> <?php echo $RecursosCons->RecursosCons['pergunta_label']; ?> </th>
                    ...
                    <tr role="row" class="filter">
                      <td></td>
                      <td><input type="text" class="form-control form-filter input-sm" name="form_pergunta" onKeyPress="submete(event)"></td>
                      <td><select name="form_categoria" class="form-control form-filter input-sm select2me" onchange="document.getElementById('pesquisa').click();">
                        ...
                        <td>&nbsp;</td>
                      <td><select name="form_visivel" class="form-control form-filter input-sm select2me" onchange="document.getElementById('pesquisa').click();">
                          <option value=""><?php echo $RecursosCons->RecursosCons['pesq_todas']; ?></option>
...
<script src="faqs-list.js" data-texto1="<?php echo $RecursosCons->RecursosCons['a_carregar']; ?>" data-texto2="<?php echo $RecursosCons->RecursosCons['selec_opcao']; ?>" data-texto3="<?php echo $RecursosCons->RecursosCons['selec_registos']; ?>"></script> 
