...
if((isset($_POST["MM_insert"])) && ($_POST["MM_insert"] == "frm_faqs")) {
	...
	if($_POST['pergunta']!='' && $_POST['categoria'] != '') {
		...
		$insertSQL = "SELECT MAX(id) FROM faqs2_pt";
    ...
    $totalRows_rsLinguas = $rsLinguas->rowCount();
  	...
  	while($row_rsLinguas = $rsLinguas->fetch()) {	
			...
			$insertSQL = "INSERT INTO faqs2_".$row_rsLinguas["sufixo"]." (id, categoria, pergunta, resposta) VALUES (:id, :categoria, :pergunta, :resposta)";
			$rsInsert = DB::getInstance()->prepare($insertSQL);
