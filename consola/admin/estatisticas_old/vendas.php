...
<div class="page-container">
  ...
  <div class="page-content-wrapper">
    <div class="page-content"> 
      <!-- BEGIN PAGE HEADER-->
      <h3 class="page-title"> <?php echo $RecursosCons->RecursosCons['vendas']; ?> </h3>
      <div class="page-bar">
                        ...
                        <table width="100%" border="0" cellpadding="0" cellspacing="0">
                          <tr>
                            ...
                            <table border="0" cellspacing="0" cellpadding="0" style="margin-bottom:30px;">
                              <tr>
                                <td>
                                <form id="form1" name="form1" method="post" action="javascript:est_vendas_carrega(document.getElementById('tipo').value, document.getElementById('from').value, document.getElementById('to').value);">
                                    <table border="0" cellspacing="0" cellpadding="0">
                                      <tr>
                                        <td width="80" align="center"><a href="javascript:imprime();"><img src="../../imgs/iconPrint.gif" width="20" border="0" /></a></td>
                                        <td width="50" align="center"><label for="tipo" class="control-label" id="l_tipo"><?php echo $RecursosCons->RecursosCons['tipo_label']; ?></label></td>
                                        <td align="center">
                                          <label>
                                            <select name="tipo" id="tipo" class="form-control select2me" style="width:200px;">
                                              ...
                                              <option value="detalhado"><?php echo $RecursosCons->RecursosCons['opt_vista_detalhada']; ?></option>
                                              <option value="transacoes"><?php echo $RecursosCons->RecursosCons['transacoes']; ?></option>
                                              <option value="top_produtos"><?php echo $RecursosCons->RecursosCons['opt_desempenho_p']; ?></option>
                                              <option value="top_categorias"><?php echo $RecursosCons->RecursosCons['opt_desempenho_c']; ?></option>
                          ...
                          <tr>
                            <td align="center"><div id="listagem"></div><div id="loading"><table width="150" border="0" cellspacing="0" cellpadding="0">
                  <tr>
...
<script type="text/javascript">
	document.ready=est_vendas_carrega("geral", '', '');
