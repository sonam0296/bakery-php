...
if((isset($_POST["MM_insert"])) && ($_POST["MM_insert"] == "filt_opcao")) {
	if($_POST['nome']!='') {
		$insertSQL = "SELECT MAX(id) FROM l_filt_opcoes_$lingua_consola";
    ...
    $totalRows_rsLinguas = $rsLinguas->rowCount();
		...
		while($row_rsLinguas = $rsLinguas->fetch()) {	
			$insertSQL = "INSERT INTO l_filt_opcoes_".$row_rsLinguas["sufixo"]." (nome, categoria, cor) VALUES (:nome, :categoria, :cor)";
			$rsInsert = DB::getInstance()->prepare($insertSQL);
      ...
      $rsInsert->bindParam(':cor', $_POST['cor'], PDO::PARAM_STR, 5); 
		...
		header("Location: filt_opcoes.php?env=1");
	}
}

$query_rsCat = "SELECT id, nome FROM  l_filt_categorias_en ORDER BY ordem ASC, nome ASC";
...
<div class="page-container">
  ...
  <div class="page-content-wrapper">
    <div class="page-content"> 
      <!-- BEGIN PAGE HEADER-->
      <h3 class="page-title"><?php echo $RecursosCons->RecursosCons['filtros']; ?> <small><?php echo $RecursosCons->RecursosCons['inserir_registo']; ?></small> </h3>
      <div class="page-bar">
          ...
          <form id="filt_opcao" name="filt_opcao" class="form-horizontal form-row-seperated" method="post" role="form" enctype="multipart/form-data">
            <div class="portlet">
              <div class="portlet-title">
                <div class="caption"> <i class="fa fa-pencil-square"></i><?php echo $RecursosCons->RecursosCons['filtros_novo_registo']; ?></div>
                  ...
                  <div class="form-group">
                    ...
                    <div class="col-md-8">
                      <select class="form-control select2me" id="categoria" name="categoria" >
                        <option value=""><?php echo $RecursosCons->RecursosCons['opt_selecionar']; ?>
