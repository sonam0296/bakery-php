...
if(isset($_GET['rem']) && $_GET['rem'] == 1) {
	if(isset($_GET['id']) && $_GET['id'] != "" && $_GET['id'] != 0) {
		...
		while($row_rsLinguas = $rsLinguas->fetch()) {
			$query_rsP = "DELETE FROM l_filt_opcoes_".$row_rsLinguas["sufixo"]." WHERE id = :id";
			$rsP = DB::getInstance()->prepare($query_rsP);
			$rsP->bindParam(':id', $id, PDO::PARAM_INT, 5);	
			$rsP->execute();
		}	
		DB::close();
		header("Location: filt_opcoes.php?r=1");
	}
}

$query_rsCat = "SELECT id, nome FROM  l_filt_categorias_$lingua_consola ORDER BY ordem ASC, nome ASC";
...
<div class="page-container">
	...
	<div class="page-content-wrapper">
		<div class="page-content">
			<!-- BEGIN PAGE HEADER-->            
			<h3 class="page-title"><?php echo $RecursosCons->RecursosCons['filtros']; ?> <small><?php echo $RecursosCons->RecursosCons['opcoes']; ?></small> </h3>
			<div class="page-bar">
				<ul class="page-breadcrumb">
					...
					<li>
						<a href="filt_opcoes.php"><?php echo $RecursosCons->RecursosCons['opcoes']; ?></a>
					</li>
				</ul>
			</div>
			<!-- END PAGE HEADER-->            
				...
				<div class="col-md-12">
					...
					<div class="portlet">
						<div class="portlet-title">
							<div class="caption">
								<i class="fa fa-search"></i> <?php echo $RecursosCons->RecursosCons['filtros']; ?>
							</div>
              <div class="actions"> <a href="filt_opcoes-insert.php" class="btn default yellow-stripe"> <i class="fa fa-plus"></i> <span class="hidden-480">  <?php echo $RecursosCons->RecursosCons['nova_opcao']; ?></span> </a> </div>
            </div>
...
<script src="filt_opcoes-rpc.js" data-texto1="<?php echo $RecursosCons->RecursosCons['a_carregar']; ?>" data-texto2="<?php echo $RecursosCons->RecursosCons['selec_opcao']; ?>" data-texto3="<?php echo $RecursosCons->RecursosCons['selec_registos']; ?>"></script>
