...
<?php
  ...
  if (isset($_REQUEST["customActionType"]) && $_REQUEST["customActionType"] == "group_action") {
    ...
    if($opcao == '-1') { // elimina utilizadores selecionados
      ...
      //  $query_rsDel = "DELETE FROM l_filt_categorias_".$row_rsLinguas["sufixo"]." WHERE id IN $lista";
      ...
      // while($row_rsLinguas = $rsLinguas->fetch()) {
      //   $insertSQL = "UPDATE l_filt_opcoes_".$row_rsLinguas["sufixo"]." SET categoria='0' WHERE categoria IN $lista";
