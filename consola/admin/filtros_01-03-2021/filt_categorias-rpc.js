var ConteudoDados = function () {
    ...
    var nome_script = $('script[src*=filt_categorias]');
    ...
    var handleProducts = function() {
        ...
        grid.init({
            ...
            dataTable: { // here you can define a typical datatable settings from http://datatables.net/usage/options 
                ...
                "ajax": {
                    "url": "filt_categorias-list.php", // ajax source,
                },
		...
		$('#bt_submete').click( function() {
			...
			$.post("filt_categorias-rpc.php", {op:"ordenar_registos", campos:data}, function(data){
				window.location='filt_categorias.php';
			});
			return false;
		} );
    }
