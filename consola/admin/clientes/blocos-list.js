var List = function () {
    ...
    var nome_script = $('script[src*=blocos]');
    ...
    var handleProducts = function() {
        ...
        grid.init({
            ...
            dataTable: { // here you can define a typical datatable settings from http://datatables.net/usage/options 
                ...
                "ajax": {
                    "url": "blocos-list.php" // ajax source
                },
        ...
        grid.getTableWrapper().on('click', '.table-group-action-submit', function (e) {
			...
			$('#bt_submete').click( function() {
				...
				$.post("blocos-rpc.php", {op:"ordenar_registos", campos:data}, function(data){
					window.location='blocos.php';
				});
				return false;
			} );
    }
