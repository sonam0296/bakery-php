...
if((isset($_POST["MM_insert"])) && ($_POST["MM_insert"] == "form_codigo")) {
    ...
    $totalRows_rsLinguas = $rsLinguas->rowCount();
		...
		$insertSQL = "SELECT MAX(id) FROM codigos_promocionais";
    ...
    if(isset($_POST['dataf']) && $_POST['dataf'] != "0000-00-00" && $_POST['dataf'] != "") $dataf = $_POST['dataf'];
		...
		$insertSQL = "INSERT INTO codigos_promocionais (id, nome, codigo, desconto, tipo_desconto, valor_minimo, grupo, id_cliente, limite_cliente, limite_total, tipo, id_categoria, id_peca, id_marca, id_country, datai, dataf, pagina) VALUES (:id, :nome, :codigo, :desconto, :tipo_desconto, :valor_minimo, :grupo, :id_cliente, :limite_cliente, :limite_total, :tipo, :id_categoria, :id_peca, :id_marca, :id_country, :datai, :dataf, :pagina)";
		$rsInsert = DB::getInstance()->prepare($insertSQL);
		$rsInsert->bindParam(':id', $id_max, PDO::PARAM_INT);
		$rsInsert->bindParam(':nome', $_POST['nome'], PDO::PARAM_STR);	
		$rsInsert->bindParam(':codigo', $_POST['codigo'], PDO::PARAM_STR, 5);	
    ...
    //Cria um registo na tabela codigos_promocionais_textos_{linguas}.
    $insertSQL = "SELECT MAX(id) FROM codigos_promocionais_texto_pt";
    $rsInsert = DB::getInstance()->prepare($insertSQL);
    $rsInsert->execute();
    $row_rsInsert = $rsInsert->fetch(PDO::FETCH_ASSOC);
    
    $id_max_texto = $row_rsInsert["MAX(id)"] + 1;

    foreach ($row_rsLinguas as $lingua) {
      $insertSQL = "INSERT INTO codigos_promocionais_texto_".$lingua['sufixo']." (id, cod_prom, texto) VALUES (:id, :cod_prom, :texto)";
      $rsInsert = DB::getInstance()->prepare($insertSQL);
      $rsInsert->bindParam(':id', $id_max_texto, PDO::PARAM_INT);
      $rsInsert->bindParam(':cod_prom', $id_max, PDO::PARAM_INT); //id do código promocional
    ...
    header('Location: cod-promo.php?suc=1');
	}
}
...
<div class="page-container">
  ...
  <div class="page-content-wrapper">
    <div class="page-content"> 
      <!-- BEGIN PAGE HEADER-->
      <h3 class="page-title"> Vales de Desconto <small>inserir registo</small> </h3>
      <div class="page-bar">
        <ul class="page-breadcrumb">
          <li> <i class="fa fa-home"></i> <a href="../index.php">Home</a> <i class="fa fa-angle-right"></i></li>
          <li> <a href="cod-promo.php">Vales de Desconto</a> <i class="fa fa-angle-right"></i></li>
          <li> <a href="javascript:;">Inserir registo</a> </li>
        </ul>
      </div>
      <!-- END PAGE HEADER--> 
      <!-- BEGIN PAGE CONTENT-->
          ...
          <form id="form_codigo" name="form_codigo" class="form-horizontal form-row-seperated" method="post" role="form" enctype="multipart/form-data">
            <div class="portlet">
              <div class="portlet-title">
                <div class="caption"> <i class="fa fa-pencil-square"></i>Vales de Desconto - Novo Registo </div>
              ...
              <div class="portlet-body">
                <div class="form-body">
                  ...
                  <div class="form-group">
                    ...
                    <div class="col-md-3">
                      <input type="text" class="form-control" name="codigo" id="codigo" value="<?php echo $_POST['codigo']; ?>" data-required="1">
                    </div>
                    <div class="col-md-2">
                  ...
                  <div class="form-group">
                    ...
                    <div class="col-md-3">
                    	<div class="input-group">
                      	<input type="text" class="form-control" name="desconto" id="desconto" value="<?php echo $_POST['desconto']; ?>" data-required="1" onkeyup="onlyDecimal(this)" onblur="onlyDecimal(this)">
                      	<span id="span_desconto" class="input-group-addon">%</span>
                      </div> 
                    </div>
                    <div class="col-md-2 md-radio-inline">
                      <div class="md-radio">
                        <input type="radio" id="desc_perc" name="radio_desconto" value="1" class="md-radiobtn" checked>
                        <label for="desc_perc">
                        <span></span>
                      ...
                      <div class="md-radio">
                        <input type="radio" id="desc_preco" name="radio_desconto" value="2" class="md-radiobtn">
                  ...
                  <div class="form-group">
                    ...
                    <div class="col-md-8 md-radio-inline">
                      <div class="md-radio">
                        <input type="radio" id="desc_total" name="tipo_desconto" value="1" class="md-radiobtn" checked>
                      ...
                      <div class="md-radio">
                        <input type="radio" id="desc_prod" name="tipo_desconto" value="2" class="md-radiobtn">
                        <label for="desc_prod">
                        <span></span>
                        <span class="check"></span>
                        <span class="box"></span>
                  ...
                  <div class="form-group">
                    ...
                    <div class="col-md-3">
                      <div class="input-group">
                        <input type="text" class="form-control" name="valor_minimo" id="valor_minimo" value="<?php echo $_POST['valor_minimo']; ?>" onkeyup="onlyDecimal(this)" onblur="onlyDecimal(this)">
                  ...
                  <div class="form-group">
                    ...
                    <div class="col-md-2">
                      <input type="text" class="form-control" name="limite_cliente" id="limite_cliente" value="1" onkeyup="onlyNumber(this)" onblur="onlyNumber(this)">
                    </div>
                    <label class="col-md-2 control-label" for="limite_cliente">Limite de clientes: </label>
                    <div class="col-md-2">
                      <input type="text" class="form-control" name="limite_de_clientes" id="limite_de_clientes" value="0" onkeyup="onlyNumber(this)" onblur="onlyNumber(this)">
                    </div>
                    <div class="col-md-2">
                              ...
                              while($row_rsCategorias2 = $rsCategorias2->fetch()) { ?>
                                ...
                                if($totalRows_rsCategorias3 > 0) {
                                  while($row_rsCategorias3 = $rsCategorias3->fetch()) { ?>
                                    <option value="<?php echo $row_rsCategorias3['id']; ?>"><?php echo $row_rsCategorias['nome']." » ".$row_rsCategorias2['nome']." » ".$row_rsCategorias3['nome']; ?></option>
                                  <?php } 
                                }
                              }
                            }
                      ...
                      <select class="form-control select2me" name="pagina" id="pagina">
                        ...
                        <?php if($totalRows_rsPaginas > 0) {
                          while($row_rsPaginas = $rsPaginas->fetch()) { ?>
                            <option value="<?php echo $row_rsPaginas['id']; ?>"><?php echo $row_rsPaginas['nome']; ?></option>
                          <?php }
                        } ?>
                      </select>
                  ...
                  <div class="form-group">
                    ...
                    <div class="col-md-8">
                      <textarea class="form-control" name="texto" id="texto"><?php echo $_POST['texto']; ?></textarea>
                    </div>
                  </div>
                </div>
              </div>
