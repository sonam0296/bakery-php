...
if(isset($_GET['rem']) && $_GET['rem'] == 1) {
    ...
    while($row_rsLinguas = $rsLinguas->fetch()) {
      $query_rsP = "DELETE FROM codigos_promocionais_texto_".$row_rsLinguas["sufixo"]." WHERE id = :id";
      ...
      DB::close();
		...
		$query_rsP = "DELETE FROM codigos_promocionais WHERE id = :id";
		$rsP = DB::getInstance()->prepare($query_rsP);
		$rsP->bindParam(':id', $id, PDO::PARAM_INT);
		$rsP->execute();
		DB::close();
		
		header("Location: cod-promo.php?r=1");
	}
}

$query_rsTipos = "SELECT id, nome FROM codigos_promocionais_tipos ORDER BY id ASC";
...
<div class="page-container">
  ...
  <div class="page-content-wrapper">
    <div class="page-content"> 
      <!-- BEGIN PAGE HEADER-->
      <h3 class="page-title"> Vales de Desconto <small>listagem</small> </h3>
      <div class="page-bar">
        <ul class="page-breadcrumb">
          <li> <i class="fa fa-home"></i> <a href="../index.php">Home</a> <i class="fa fa-angle-right"></i> </li>
          <li> <a href="cod-promo.php">Vales de Desconto </a> </li>
        </ul>
      </div>
      <!-- END PAGE HEADER--> 
      <!-- BEGIN PAGE CONTENT-->
        ...
        <div class="col-md-12"> 
          ...
          <div class="portlet">
            <div class="portlet-title">
              <div class="caption"> <i class="fa fa-pencil-square"></i>Vales de Desconto </div>
              <div class="actions"> <a href="cod-promo-insert.php" class="btn default yellow-stripe"> <i class="fa fa-plus"></i> <span class="hidden-480"> Novo Registo </span> </a> </div>
            </div>
              ...
              <div class="table-container">
                <div class="table-actions-wrapper"> <span> </span>
                  <select class="table-group-action-input form-control input-inline input-small input-sm">
                    ...
                    <option value="3">Não vis?vel</option>
                ...
                <table class="table table-striped table-bordered table-hover" id="datatable_products">
                  <thead>
                    <tr role="row" class="heading">
                      ...
                      <th width="10%">Fim</th>
                      <th width="10%">Visível no Website</th>
                    ...
                    <tr role="row" class="filter">
                      ...
                      <td><select name="form_visivel_listagem" class="form-control form-filter input-sm" onchange="document.getElementById('pesquisa').click();">
                          <option value="">Todos</option>
...
<script src="cod-promo-list.js"></script> 
