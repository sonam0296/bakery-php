					...
					do {
						...
						if($totalRows_rsLinguas>0) {
							...
							do {
								...
								$insertSQL = "UPDATE l_pecas_en SET stock=stock+:qtd WHERE id=:produto_conjunto";		
				...
				if($totalRows_rsT>0) {
					...
					if($totalRows_rsLinguas>0) {		
						...
						do {	
							...
							$insertSQL = "UPDATE l_pecas_en SET stock=stock+ :qtd WHERE id=:produto";		
					...
					if($stock_disponivel<0) {
						...
						if($totalRows_rsLinguas>0) {
							...
							do {
								...
								$insertSQL = "UPDATE l_pecas_en SET stock='0' WHERE id=:produto";		
...
$query_rsMetPagamento = "SELECT mp.* FROM met_pagamento_en mp, encomendas e WHERE e.id=:id_encomenda AND e.met_pagamt_id=mp.id";
...
$query_rsLastOrder = "SELECT e.*, es.nome_en, es.id AS estado_id FROM encomendas e, enc_estados es WHERE e.id_cliente=:id_cliente AND e.estado = es.id AND e.id< :id ORDER BY e.id DESC";
														...
														<div id="encomenda">
															...
															<div class="row static-info">
																...
																<div class="col-md-8 value">
																	...
																	<?php echo $row_rsEstado['nome_en']; ?> </span>
														...
														<div class="table-responsive">
															...
															<table class="table table-hover table-bordered table-striped">
																...
																<tbody>
		                                							...
		                                							<tr>
		                                									<td>
																			<img src="<?php echo $row_rsCarrinho['imagem1'];   ?>" width="50px" height="50px" />
												...
												<tbody>
													...
													<?php if($totalRows_rsEncHist > 0) {
														...
														while($row = $rsEncHist->fetch()) {
															...
															$query_rsEstadoHist = "SELECT nome_en FROM enc_estados WHERE id=:id";
															...
															<tr>
																...
																<td>
																	...
																	<?php echo $RecursosCons->RecursosCons['encomenda_estado_msg']; ?>: <strong><?php echo $row_rsEstadoHist['nome_en']; ?></strong> <?php echo $automatico; ?>
