...
if((isset($_POST["MM_insert"])) && ($_POST["MM_insert"] == "frm_promocoes")) {
  if($_POST['nome']!="" && $_POST['desconto'] != '' && $_POST['datai'] != '' && $_POST['dataf'] != '') {
    $insertSQL = "SELECT MAX(id) FROM l_promocoes_pt";
    ...
    while($row_rsLinguas = $rsLinguas->fetch()) {
      $insertSQL = "INSERT INTO l_promocoes_".$row_rsLinguas['sufixo']." (id, nome, pagina, titulo, texto, desconto, id_categoria, id_marca, id_peca, datai, dataf) VALUES (:id, :nome, :pagina, :titulo, :texto, :desconto, :id_categoria, :id_marca, :id_peca, :datai, :dataf)";
      $rsInsert = DB::getInstance()->prepare($insertSQL);
    ...
    header('Location: promocoes.php?suc=1');
  }
}
...
<div class="page-container">
  ...
  <div class="page-content-wrapper">
    <div class="page-content"> 
      <!-- BEGIN PAGE HEADER-->
      <h3 class="page-title"> <?php echo $RecursosCons->RecursosCons['menu_promocoes']; ?> <small><?php echo $RecursosCons->RecursosCons['inserir_registo']; ?></small> </h3>
      <div class="page-bar">
        <ul class="page-breadcrumb">
          ...
          <li> <a href="promocoes.php"><?php echo $RecursosCons->RecursosCons['menu_promocoes']; ?> </a> <i class="fa fa-angle-right"></i></li>
      ...
      <div class="row">
        <div class="col-md-12">
          <form id="frm_promocoes" name="frm_promocoes" class="form-horizontal form-row-seperated" method="post" role="form" enctype="multipart/form-data">
            <div class="portlet">
              <div class="portlet-title">
                <div class="caption"> <i class="fa fa-pencil-square"></i><?php echo $RecursosCons->RecursosCons['menu_promocoes']; ?> - <?php echo $RecursosCons->RecursosCons['novo_registo']; ?> </div>
                <div class="form-actions actions btn-set">
                  <button type="button" name="back" class="btn default" onClick="document.location='promocoes.php'"><i class="fa fa-angle-left"></i> <?php echo $RecursosCons->RecursosCons['voltar']; ?></button>
              ...
              <div class="portlet-body">
                <div class="form-body">
                  ...
                  <div class="form-group">
                    ...
                    <label class="col-md-2 control-label" for="dataf"><?php echo $RecursosCons->RecursosCons['data_fim_label']; ?>: <span class="required"> * </span></label>
                    <div class="col-md-3">
                      <div class="input-group date date-picker" data-date-format="yyyy-mm-dd">
                  ...
                  <div class="form-group">
                    <label class="col-md-2 control-label" for="desconto"><?php echo $RecursosCons->RecursosCons['cli_desconto']; ?>: <span class="required"> * </span> </label>
                    <div class="col-md-3">
                      <div class="input-group">
                        <input type="text" class="form-control" name="desconto" id="desconto" value="<?php echo $_POST['desconto']; ?>" onkeyup="onlyDecimal(this)" onblur="onlyDecimal(this)">
                  ...
                  <div class="form-group">
                    ...
                    <div class="col-md-8">
                      <span class="label label-danger"><?php echo $RecursosCons->RecursosCons['nota_txt']; ?>:</span> <?php echo $RecursosCons->RecursosCons['promocoes_aviso']; ?>
                    </div>
                  </div>
                  <div class="form-group">
                    ...
                    <div class="col-md-8">
                      <div id="div_categorias">
                        <select class="form-control select2me" name="categoria" id="categoria" onChange="carregaProdutos(this.value, $('#marca').val());">
                          <option value=""><?php echo $RecursosCons->RecursosCons['opt_selecionar']; ?></option>
                           <?php umaCategoriaPorProd(0, "", -1, 1); ?>
                        </select>
                      </div>
                    </div>
                  </div>
                  <div class="form-group">
                    ...
                    <div class="col-md-8">
                      <div id="div_marcas">
                        <select class="form-control select2me" name="marca" id="marca" onChange="carregaProdutos($('#categoria').val(), this.value);">
                          <option value=""><?php echo $RecursosCons->RecursosCons['opt_selecionar']; ?></option>
                  ...
                  <div class="form-group">
                    <label class="col-md-2 control-label" for="produto"><?php echo $RecursosCons->RecursosCons['produto']; ?>: </label>
                    <div class="col-md-8">
                      <div id="div_produtos">
                  ...
                  <div class="form-group">
                    ...
                    <div class="col-md-8">
                      <input type="text" class="form-control" name="titulo" id="titulo" value="<?php echo $row_rsTexto['titulo']; ?>">
                  ...
                  <div class="form-group">
                    ...
                    <div class="col-md-8">
                      <textarea class="form-control" name="texto" id="texto"><?php echo $row_rsTexto['texto']; ?></textarea>
                    </div>
                  </div>
                </div>
              </div>
            </div>
            <input type="hidden" name="MM_insert" value="frm_promocoes" />
          </form>
        </div>
      </div>
      <!-- END PAGE CONTENT--> 
