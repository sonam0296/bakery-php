...
if(isset($_GET['rem']) && $_GET['rem'] == 1) {
  if(isset($_GET['id']) && $_GET['id'] != "" && $_GET['id'] != 0) {
    ...
    while($row_rsLinguas = $rsLinguas->fetch()) {
      $query_rsP = "DELETE FROM l_promocoes_".$row_rsLinguas['sufixo']." WHERE id = :id";
    ...
    header("Location: promocoes.php?r=1");
  }
}
...
<div class="page-container">
  ...
  <div class="page-content-wrapper">
    <div class="page-content"> 
      <!-- BEGIN PAGE HEADER-->
      <h3 class="page-title"> <?php echo $RecursosCons->RecursosCons['menu_promocoes']; ?> <small><?php echo $RecursosCons->RecursosCons['menu_listagem']; ?></small> </h3>
      <div class="page-bar">
        <ul class="page-breadcrumb">
          ...
          <li> <a href="promocoes.php"><?php echo $RecursosCons->RecursosCons['menu_promocoes']; ?> </a> </li>
        </ul>
      </div>
      <!-- END PAGE HEADER--> 
      <!-- BEGIN PAGE CONTENT-->
        ...
        <div class="col-md-12"> 
          ...
          <div class="portlet">
            <div class="portlet-title">
              <div class="caption"> <i class="fa fa-pencil-square"></i><?php echo $RecursosCons->RecursosCons['menu_promocoes']; ?> </div>
              <div class="actions"> <a href="promocoes-insert.php" class="btn default yellow-stripe"> <i class="fa fa-plus"></i> <span class="hidden-480"> <?php echo $RecursosCons->RecursosCons['novo_registo']; ?> </span> </a> </div>
            </div>
              ...
              <div class="table-container">
                <div class="table-actions-wrapper"> <span> </span>
                  <select class="table-group-action-input form-control input-inline input-small input-sm">
                    ...
                    <option value="0"><?php echo $RecursosCons->RecursosCons['nao_visivel']; ?></option>
                ...
                <table class="table table-striped table-bordered table-hover" id="datatable_products">
                  <thead>
                    <tr role="row" class="heading">
                      ...
                      <th width="20%"><?php echo $RecursosCons->RecursosCons['marca_label']; ?></th>
                    ...
                    <tr role="row" class="filter">
                      ...
                      <td>
                        <select name="form_categoria" class="form-control form-filter input-sm select2me" onchange="document.getElementById('pesquisa').click();">
                          <option value=""><?php echo $RecursosCons->RecursosCons['pesq_todas']; ?></option>
                          <?php umaCategoriaPorProd(0, "", -1, 1); ?>
                        </select>
                      </td>
                      <td>
                        <select name="form_marca" class="form-control form-filter input-sm select2me" onchange="document.getElementById('pesquisa').click();">
                          <option value=""><?php echo $RecursosCons->RecursosCons['pesq_todas']; ?></option>
                      ...
                      <td>
                        <select name="form_activo" class="form-control form-filter input-sm" onchange="document.getElementById('pesquisa').click();">
                          <option value=""><?php echo $RecursosCons->RecursosCons['pesq_todas']; ?></option>
                          <option value="1"><?php echo $RecursosCons->RecursosCons['pesq_sim']; ?></option>
                          <option value="0"><?php echo $RecursosCons->RecursosCons['pesq_nao']; ?></option>
                        </select>
                      </td>
                      <td>
...
<script src="promocoes-list.js" data-texto1="<?php echo $RecursosCons->RecursosCons['a_carregar']; ?>" data-texto2="<?php echo $RecursosCons->RecursosCons['selec_opcao']; ?>" data-texto3="<?php echo $RecursosCons->RecursosCons['selec_registos']; ?>"></script> 
