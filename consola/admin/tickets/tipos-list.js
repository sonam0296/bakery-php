var ServicosList = function () {
    ...
    var nome_script = $('script[src*=catalogos]');
    ...
    var handleProducts = function() {
        ...
        grid.init({
            ...
            dataTable: { // here you can define a typical datatable settings from http://datatables.net/usage/options 
                ...
                "ajax": {
                    "url": "tipos-list.php", // ajax source,
                },
		...
		$('#bt_submete').click( function() {
			...
			$.post("tipos-rpc.php", {op:"ordenar_registos", campos:data}, function(data){
