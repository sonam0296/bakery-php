...
if((isset($_POST["MM_insert"])) && ($_POST["MM_insert"] == "frm_tipos")) {
	if($_POST['nome'] != '') {
		$insertSQL = "SELECT MAX(id) FROM tickets_tipos_pt";
    ...
    $totalRows_rsLinguas = $rsLinguas->rowCount();
		...
		while($row_rsLinguas = $rsLinguas->fetch()) {
			$insertSQL = "INSERT INTO tickets_tipos_".$row_rsLinguas["sufixo"]." (id, nome) VALUES (:id, :nome)";
			$rsInsert = DB::getInstance()->prepare($insertSQL);
    ...
    DB::close();
		...
		header("Location: tipos.php?ins=1");
	}	
}
...
<div class="page-container">
  ...
  <div class="page-content-wrapper">
    <div class="page-content"> 
      <!-- BEGIN PAGE HEADER-->
      <h3 class="page-title"> <?php echo $RecursosCons->RecursosCons['tickets']; ?> <small> <?php echo $RecursosCons->RecursosCons['inserir_registo']; ?> </small> </h3>
      <div class="page-bar">
          ...
          <form id="frm_tipos" name="frm_tipos" class="form-horizontal form-row-seperated" method="post" role="form" enctype="multipart/form-data">
            <div class="portlet">
              <div class="portlet-title">
                <div class="caption"> <i class="fa fa-pencil-square"></i><?php echo $RecursosCons->RecursosCons['tipos_novo_registo']; ?> </div>
