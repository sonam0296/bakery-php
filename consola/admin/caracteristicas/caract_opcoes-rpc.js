var ConteudoDados = function () {
    ...
    var nome_script = $('script[src*=caract_opcoes]');
    ...
    var handleProducts = function() {
        ...
        grid.init({
            ...
            dataTable: { // here you can define a typical datatable settings from http://datatables.net/usage/options 
                ...
                "ajax": {
                    "url": "caract_opcoes-list.php", // ajax source,
                },
		...
		$('#bt_submete').click( function() {
			...
			$.post("caract_opcoes-rpc.php", {op:"ordenar_registos", campos:data}, function(data){
				window.location='caract_opcoes.php';
			});
			return false;
		} );
    }
