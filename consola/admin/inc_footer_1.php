...
<?php if(file_exists(ROOTPATH_CONSOLA."assets/global/scripts/datatable_".$lingua_consola.".js")) { ?>
	<script src="<?php echo ROOTPATH_HTTP_CONSOLA; ?>assets/global/scripts/datatable_<?php echo $lingua_consola; ?>.js"></script>
<?php } else { ?>
	<script src="<?php echo ROOTPATH_HTTP_CONSOLA; ?>assets/global/scripts/datatable_pt.js"></script>
<?php } ?>
<!-- END FOOTER -->
