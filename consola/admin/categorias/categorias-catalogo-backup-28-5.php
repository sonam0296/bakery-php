...
if((isset($_GET["op"])) && ($_GET["op"] == "rem_file")) {
    ...
    if($opcao == 1) {
      ...
      //Se a vari�vel for igual a 0, significa que o catalogo n�o  usada em mais nenhum registo e podemos remove-lo
      if($r == 0)
...
$query_rsP = "SELECT id, nome, catalogo FROM l_categorias".$extensao." WHERE id=:id";
