...
if(isset($_GET['rem']) && $_GET['rem'] == 1) {
    ...
    while($row_rsLinguas = $rsLinguas->fetch()) {
      $query_rsP = "SELECT imagem FROM homepage_image_".$row_rsLinguas['sufixo']." WHERE id = :id";
      ...
      $query_rsDel = "DELETE FROM homepage_image_".$row_rsLinguas['sufixo']." WHERE id=:id";
    ...
    DB::close();
		...
		header("Location: homepage-image.php?r=1");
	}
}
...
<div class="page-container">
  ...
  <div class="page-content-wrapper">
    <div class="page-content"> 
      <!-- BEGIN PAGE HEADER-->
      <h3 class="page-title"> <?php echo $RecursosCons->RecursosCons['imagelabel_homepage']; ?>  <small><?php echo $RecursosCons->RecursosCons['listagem']; ?> </small> </h3>
      <div class="page-bar">
        <ul class="page-breadcrumb">
          <li> <i class="fa fa-home"></i> <a href="../index.php"><?php echo $RecursosCons->RecursosCons['home']; ?> </a> <i class="fa fa-angle-right"></i> </li>
          <li> <a href="homepage-image.php"><?php echo $RecursosCons->RecursosCons['imagelabel_homepage']; ?> </a> </li>
        </ul>
      </div>
      <!-- END PAGE HEADER--> 
      <!-- BEGIN PAGE CONTENT-->
        ...
        <div class="col-md-12"> 
          ...
          <div class="portlet">
            <div class="portlet-title">
              <div class="caption"> <i class="fa fa-pencil-square"></i><?php echo $RecursosCons->RecursosCons['imagelabel_homepage']; ?>  </div>
              <div class="actions"> <a href="image-insert.php" class="btn default yellow-stripe"> <i class="fa fa-plus"></i> <span class="hidden-480"><?php echo $RecursosCons->RecursosCons['novo_image_homepage']; ?>  </span> </a> </div>
            </div>
                ...
                <table class="table table-striped table-bordered table-hover" id="datatable_products">
                  <thead>
                    <tr role="row" class="heading">
                      ...
                      <th width="15%"> <?php echo $RecursosCons->RecursosCons['titulo_label']; ?> </th>
                      <th width="15%"> <?php echo $RecursosCons->RecursosCons['link_label']; ?> </th>
                      <th width="15%"> <?php echo $RecursosCons->RecursosCons['visivel_tab']; ?>  </th>
...
<script src="image-list.js" data-texto1="<?php echo $RecursosCons->RecursosCons['a_carregar']; ?>" data-texto2="<?php echo $RecursosCons->RecursosCons['selec_opcao']; ?>" data-texto3="<?php echo $RecursosCons->RecursosCons['selec_registos']; ?>" ></script> 
