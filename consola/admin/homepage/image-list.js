var List = function () {
    ...
    var nome_script = $('script[src*=homepage-image]');
    ...
    var handleProducts = function() {
        ...
        grid.init({
            ...
            dataTable: { // here you can define a typical datatable settings from http://datatables.net/usage/options 
                ...
                "ajax": {
                    "url": "image-list.php" // ajax source
                },
		...
		$('#bt_submete').click( function() {
			...
			$.post("image-rpc.php", {op:"ordenar_registos", campos:data}, function(data){
				window.location='homepage-image.php';
			});
			return false;
		} );
    }
