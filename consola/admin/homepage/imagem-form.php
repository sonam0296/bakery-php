...
if((isset($_POST["MM_insert"])) && ($_POST["MM_insert"] == "frm_imagem_form")) {
	$manter = $_POST['manter'];
	
	if(isset($_POST['descricao'])){
		$queryDesc = "UPDATE homepage".$extensao." SET texto_form = :descricao WHERE id=:id";
	...
	$query_rsP = "SELECT imagem_form, texto_form FROM homepage".$extensao." WHERE id=:id";
	...
	$rem = 0;
	$opcao = $_POST['opcao'];
	$imagem = $row_rsP['imagem_form'];

	if(isset($_POST['img_remover1']) && $_POST['img_remover1']==1) {
		$array_imagens = array();
    $array_imagens['imagem_form'] = $imagem2;
	...
	if($_FILES['img']['name']!='') { // actualiza imagem
		...
		if($ext != "jpg" && $ext != "jpeg" && $ext != "gif" && $ext != "png") {
			...
			if($_FILES['img']['name']!='') {
				...
				if($row_rsP['imagem_form']) {
					$array_imagens = array();
		      $array_imagens['imagem_form'] = $row_rsP['imagem_form'];
		      apagaFicheiros('homepage', 'homepage', $id, $extensao, $array_imagens, $opcao);
				}
				...
				if($opcao == 1) {
					$insertSQL = "UPDATE homepage".$extensao." SET imagem_form=:imagem_form WHERE id=:id";
					$rsInsert = DB::getInstance()->prepare($insertSQL);
					$rsInsert->bindParam(':imagem_form', $imagem, PDO::PARAM_STR, 5);
				...
				//Inserir para todas as línguas
					...
					foreach ($row_rsLinguas as $linguas) {		
						$insertSQL = "UPDATE homepage_".$linguas["sufixo"]." SET imagem_form=:imagem_form WHERE id=:id";
						$rsInsert = DB::getInstance()->prepare($insertSQL);
						$rsInsert->bindParam(':imagem_form', $imagem, PDO::PARAM_STR, 5);
						$rsInsert->bindParam(':id', $id, PDO::PARAM_INT);		
						$rsInsert->execute();
	...
	header("Location: imagem-form.php?alt=1");			
...
<div class="page-container">
  ...
  <div class="page-content-wrapper">
    <div class="page-content"> 
      <!-- BEGIN PAGE HEADER-->
      <h3 class="page-title"> <?php echo $RecursosCons->RecursosCons['menu_imgs_form']; ?> <small><?php echo $RecursosCons->RecursosCons['menu_homepage']; ?></small> </h3>
      <div class="page-bar">
        <ul class="page-breadcrumb">
          ...
          <li> <a href="javascript:;"><?php echo $RecursosCons->RecursosCons['menu_imgs_form']; ?> </a> <i class="fa fa-angle-right"></i></li>
      ...
      <div class="row">
        <div class="col-md-12">
          ...
          <form id="frm_imagem_form" name="frm_imagem_form" class="form-horizontal form-row-seperated" method="post" role="form" enctype="multipart/form-data">
            <input type="hidden" name="manter" id="manter" value="0">
            <input type="hidden" name="img_remover1" id="img_remover1" value="0">
	          <div class="portlet">
	            <div class="portlet-title">
	              <div class="caption"> <i class="fa fa-pencil-square"></i><?php echo $RecursosCons->RecursosCons['menu_imgs_form']; ?> </div>
                ...
                <div class="form-body">
                  ...
                  <?php } ?>
									...
									<div class="form-group">
										...
										<div class="col-md-8">
											<textarea class="form-control" id="descricao" name="descricao"><?php echo $row_rsP['texto_form']; ?></textarea>
										</div>
									</div>
                    ...
                    <div class="col-md-4">
                      <div class="fileinput fileinput-<?php if($row_rsP['imagem_form']!="" && file_exists("../../../imgs/homepage/".$row_rsP['imagem_form'])) { ?>exists<?php } else { ?>new<?php } ?>" data-provides="fileinput">
                        ...
                        <div class="fileinput-preview fileinput-exists thumbnail" style="max-width: 200px; max-height: 150px;">
                          <?php if($row_rsP['imagem_form']!="" && file_exists("../../../imgs/homepage/".$row_rsP['imagem_form'])) { ?>
                          <a href="../../../imgs/homepage/<?php echo $row_rsP['imagem_form']; ?>" data-fancybox ><img src="../../../imgs/homepage/<?php echo $row_rsP['imagem_form']; ?>"></a>
                          <?php } ?>
                        </div>
	          ...
	          <input type="hidden" name="MM_insert" value="frm_imagem_form" />
          </form>
        </div>
      </div>
      <!-- END PAGE CONTENT--> 
