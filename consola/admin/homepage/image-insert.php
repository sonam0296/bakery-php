...
if((isset($_POST["MM_insert"])) && ($_POST["MM_insert"] == "frm_imgInsert")) {
	if($_POST['nome']!='') {
		$insertSQL = "SELECT MAX(id) FROM homepage_image".$extensao;
		...
		while($row_rsLinguas = $rsLinguas->fetch()) {
			$insertSQL = "INSERT INTO homepage_image_".$row_rsLinguas["sufixo"]." (id, nome, titulo, link ) VALUES (:id, :nome, :titulo, :link)";
			$rsInsert = DB::getInstance()->prepare($insertSQL);
		...
		header("Location: image-edit.php?id=".$id."&v=2&tab_sel=2");
	} 
}
...
<div class="page-container">
  ...
  <div class="page-content-wrapper">
    <div class="page-content"> 
      <!-- BEGIN PAGE HEADER-->
      <h3 class="page-title"> <?php echo $RecursosCons->RecursosCons['image_homepage']; ?> <small><?php echo $RecursosCons->RecursosCons['inserir_registo']; ?></small> </h3>
      <div class="page-bar">
        <ul class="page-breadcrumb">
          <li> <i class="fa fa-home"></i> <a href="../index.php"><?php echo $RecursosCons->RecursosCons['home']; ?></a> <i class="fa fa-angle-right"></i> </li>
          <li> <a href="destaques.php"><?php echo $RecursosCons->RecursosCons['image_homepage']; ?> </a> <i class="fa fa-angle-right"></i></li>
          ...
          <form id="frm_destaques" name="frm_destaques" class="form-horizontal form-row-seperated" method="post" role="form" enctype="multipart/form-data">
            <div class="portlet">
              <div class="portlet-title">
                <div class="caption"> <i class="fa fa-pencil-square"></i><?php echo $RecursosCons->RecursosCons['image_homepage_novo_registo']; ?> </div>
              ...
              <div class="portlet-body">
                <div class="form-body">
                  ...
                  <div class="form-group">
                    ...
                    <div class="col-md-8">
                      <input type="text" class="form-control" name="titulo" id="titulo" value="<?php echo $_POST['icone1']; ?>">
                    </div>
                  </div>
                  <div class="form-group">
            ...
            <input type="hidden" name="MM_insert" value="frm_imgInsert" />
          </form>
        </div>
      </div>
      <!-- END PAGE CONTENT--> 
