...
if((isset($_POST["MM_insert"])) && ($_POST["MM_insert"] == "frm_categorias")) {	
    ...
    $totalRows_rsLinguas = $rsLinguas->rowCount();
		...
		while($row_rsLinguas = $rsLinguas->fetch()) {
			...
			$insertSQL = "INSERT INTO faqs_categorias_".$row_rsLinguas["sufixo"]." (id, nome) VALUES (:id, :nome)";
			$rsInsert = DB::getInstance()->prepare($insertSQL);
    ...
    alteraSessions('faqs');
		...
		header("Location: categorias.php?ins=1");
	}
}
          ...
          <form id="frm_categorias" name="frm_categorias" class="form-horizontal form-row-seperated" method="post" role="form" enctype="multipart/form-data">
            <div class="portlet">
              <div class="portlet-title">
                <div class="caption"> <i class="fa fa-calendar"></i><?php echo $RecursosCons->RecursosCons['faqs_novo_registo']; ?> </div>
