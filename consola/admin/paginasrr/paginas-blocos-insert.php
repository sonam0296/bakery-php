...
if((isset($_POST["MM_insert"])) && ($_POST["MM_insert"] == "paginas_blocos_form")) {
  ...
  if($_POST['nome'] != '' && $_POST['tipo'] != '') {
    ...
    if($_POST['tipo'] == 5) {
      ...
      $query_rsExiste = "SELECT id FROM paginas_blocos_en WHERE pagina = :pagina AND tipo = 5";
    ...
    $insertSQL = "SELECT MAX(id) FROM paginas_blocos_en";
    ...
    while($row_rsLinguas = $rsLinguas->fetch()) {       
      ...
      $insertSQL = "INSERT INTO paginas_blocos_".$row_rsLinguas["sufixo"]." (pagina, nome, titulo, tipo) VALUES (:pagina, :nome, :titulo, :tipo)";
