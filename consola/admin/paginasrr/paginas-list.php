...
<?php //ini_set('display_errors', 1);
  ...
  $query_rsTotal = "SELECT * FROM paginas_en WHERE fixo='$fixo' AND id > '0'".$where_pesq.$sOrder;
  ...
  $query_rsTotal = "SELECT * FROM paginas_en WHERE fixo='$fixo' AND id > '0'".$where_pesq.$sOrder." LIMIT $iDisplayStart, $iDisplayLength";
