var EspecializacoesList = function () {
    ...
    var nome_script = $('script[src*=paginas-blocos-timeline]');
    var texto1 = nome_script.attr('data-texto1');
    var texto2 = nome_script.attr('data-texto2');
    var texto3 = nome_script.attr('data-texto3');
    var bloco = nome_script.attr('data-bloco');
    var pagina = nome_script.attr('data-pagina');
    var fixo = nome_script.attr('data-fixo');
    ...
    var handleProducts = function() {
        ...
        grid.init({
            ...
            dataTable: { // here you can define a typical datatable settings from http://datatables.net/usage/options 
                ...
                "ajax": {
                    "url": "paginas-blocos-timeline-list.php?id_bloco="+bloco+"&pagina="+pagina+"&fixo="+fixo // ajax source
                },
		...
		$('#bt_submete').click( function() {
			var table = $("#datatable_products").DataTable();
			var data = table.$('input, select').serialize();
			$.post("paginas-blocos-timeline-rpc.php", {op:"ordenar_registos", campos:data}, function(data){
				window.location='paginas-blocos-timeline.php?fixo='+fixo+'&pagina='+pagina+'&id='+bloco;
			});
			return false;
		} );
    }
