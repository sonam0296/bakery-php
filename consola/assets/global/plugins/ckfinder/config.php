...
function CheckAuthentication()
{
	...
	// user logs in your system. To be able to use session variables dont
...
*/
####LOCAL_PATH####
$baseUrl = "http://192.168.1.230/trabalhos/N/natura_saude/site/imgs/uploads/";
####LOCAL_PATH####
...
//$baseDir = resolveUrl($baseUrl);
####LOCAL_PATH2####
$baseDir = "/media/trabalhos/N/natura_saude/site/imgs/uploads/";
####LOCAL_PATH2####
...
If enabled, characters with diactric marks, like å, ä, ö, ć, ĝ, đ, š
