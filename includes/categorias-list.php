									...
									<?php echo getFill('linhas', 2); ?>
										...
										<figcaption class="info">
											...
											<?php if(!empty($categoria['id_linha'])){ ?>
												<button class="button invert border " onclick="carregaCategoriaLinha('<?php echo ROOTPATH_HTTP.$url_cat; ?>', <?php echo $categoria['id_linha'];?>)"><?php echo $Recursos->Resources["saiba_mais"]; ?></button>
											<?php }else{ ?>
												<button class="button invert border " onclick="window.location.href='<?php echo ROOTPATH_HTTP.$url_cat; ?>'"><?php echo $Recursos->Resources["saiba_mais"]; ?></button>
											<?php } ?>
