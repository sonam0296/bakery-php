...
$pagWhyChooseUs = $paginasInfo[9]['info'];
$pagWhatWeLookFor = $paginasInfo[13]['info'];
    ...
    <div class="row align-middle">
      ...
      <ul  class="column navbar-nav">
         <li class="menu-item show-for-medium">
              <a href="index.php" class="nav-link uppercase <?php if($cat_redirect == $cats['id'] || $sub_redirect == $cats['id']) echo ' active';?> <?php if(!empty($subs_cats)) echo "header_drop"; ?>" data-id="<?php echo $cats['id']; ?>">home</a>
        </li>
       ...
       <?php 
          foreach($GLOBALS['divs_categorias'] as $cats) {
           ...
           if($cats["highlight_visible"] == 1) {
        ?>

          <li class="menu-item show-for-medium"><a class="nav-link uppercase header_drop" href="<?php echo ROOTPATH_HTTP_LANG.$cats['url']; ?>"><?php

          echo ($cats["nav_name"] == "") ? $cats["nome"] : $cats["nav_name"]; ?>
            
          </a>
         <?php if(!empty($subs_cats)) { ?>
            <ul class="dropdown" <?php if($cat_redirect == $cats['id'] || $sub_redirect == $cats['id']) echo ' style="display:block;"'; ?>>
              <?php foreach($subs_cats as $subs) { 
                  ...
                  ?>
              <li><a href="<?php echo ROOTPATH_HTTP_LANG.$subs['url']; ?>"><?php echo $subs["nome"]; ?></a></li>
            <?php } ?>
            </ul>
          <?php } ?>
          </li>
        ...
        <li class="menu-item show-for-medium">
              <a href="javascript:;" class="nav-link uppercase  <?php if(!empty($subs_cats)) echo "header_drop"; ?>">Frenchise</a>
  
           <ul class="dropdown">
              <li>
                <a href="<?php echo ROOTPATH_HTTP_LANG.$pagWhyChooseUs['url']; ?>">WHY CHOOSE US</a>
              </li>

              <li>
                <a href="<?php echo ROOTPATH_HTTP_LANG.$pagWhatWeLookFor['url']; ?>">WHAT WE LOOK</a>
              </li>

              <li>
                <a href="javascript:;">THE PROCESS</a>
              </li>
            </ul> 
        </li>

         <li class="menu-item show-for-medium">
              <a href="login.php" class="nav-link uppercase <?php if(!empty($subs_cats)) echo "header_drop"; ?>" >MY ACCOUNT</a>
        </li>

        <li class="menu-item show-for-medium">
              <a href="store-locater.php" class="nav-link uppercase <?php if(!empty($subs_cats)) echo "header_drop"; ?>">STORE LOCATER</a>
        </li>
      </ul>
