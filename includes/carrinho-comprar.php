...
/*  if(document.getElementsByName('delivery')) {
  ...
  if(document.getElementById('datepicker')) {
    _datepicker = document.getElementById('datepicker').value;
  }
*/
  if(_nome2 == 0) {
...
carrega_metodos();
  ...
  <script type="text/javascript">
    ...
    {  
    var doorcheck1= $('input[name=delivery]:checked').val();
          $.ajax({
                url : "store_popup.php",
                type : "POST",
                data : doorcheck1,
  ...
  $.ajax({
    url: 'store_popup.php',
    type: 'POST',
    data: {data_id: data_id, doorcheck1: doorcheck1},
  })
  .done(function(html) {
    console.log("success");
  ...
  var postal_code = document.getElementById('postal_code').value;
   ...
   $.ajax({
      ...
      success: function (data) {
        ...
        $("#miless").html(data.store_one_pin);
    }
  });
