...
<section class="div_100 links-section">
  ...
  <div class="row">
      ...
      <div class="column small-6 medium-2">
        <h3 class="list_subtit">Bismillah Bakery</h3>
          <div>
            <ul>
              <li><a class="list_txt" href="#">About us</a></li>
              <li><a class="list_txt" href="store-locater.php">Store Locater</a></li>
              <li><a class="list_txt" href="<?php echo ROOTPATH_HTTP_LANG.$pagMetodos['url']; ?>">Refund Policy</a></li>
              <li><a class="list_txt" href="faqs.php"><?php echo $Recursos->Resources["faqs"]; ?></a></li>
              <li><a class="list_txt" href="#">Contact us</a></li>
            </ul>
          </div>
      </div>
      <?php } ?>
      ...
      <div class="column small-6 medium-2">
        <h3 class="list_subtit">Social</h3>
        <div><!--
...
<section class="div_100 section-direitos">
  <div class="row align-middle">
    ...
    <div class="column medium-2 text-right show-for-medium medium-order-3">
      <a class="icon-netgocio" href="http://bbakery.co.uk/" target="_blank"></a>
    </div>
  </div>
</section>
</footer>
