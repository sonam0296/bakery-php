            ...
            <div class="row comprar disabled">
              <div class="column">
                <form action="carrinho-comprar3.php" id="comprar2" name="comprar2" method="post" onSubmit="return validaPasso()" autocomplete="off" novalidate>   
                  ...
                  <?php 
                  $data_send = $_POST["data"]; 
                  $Ptime = $_POST["Ptime"]; 

                  session_start();
                  $_SESSION["Checkpickup"] = $Checkpickup;
                  $_SESSION["data"] = $data_send;

                  ?>
                  <input type="hidden" id="prepare" name="prepare" value="<?php echo $_POST['prepare']; ?>">
                  <input type="hidden" name="Ptime" value="<?php echo $Ptime; ?>">
                  <input type="hidden" name="Checkpickup" value="<?php echo $Checkpickup; ?>">
                  <input type="hidden" name="data" value="<?php echo $data_send; ?>">
                  <input type="radio" id="pickup" name="delivery" value="0">
