                    ...
                    <form action="" data-error="<?php echo $Recursos->Resources["comprar_preencher"]; ?>"  method="post" name="form_contactos" id="form_contactos" novalidate autocomplete="off" nearby-validator>
                        <div class="animated_elements right"> 
                            ...
                            <div class="inpt_holder textarea">
                                <label class="inpt_label" for="<?php echo $form_contactos['mensagem']; ?>"><?php echo $Recursos->Resources["mensagem"];?> *</label><textarea style="height: 15rem !important;" required class="inpt inpt_conto" id="<?php echo $form_contactos['mensagem']; ?>" name="<?php echo $form_contactos['mensagem']; ?>" autocomplete="message"></textarea>
                                <div class="inpt_error"></div>
                            </div>
