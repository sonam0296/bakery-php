...
if($_POST['nome'] != "" && $_POST['email'] != "" && $empty > 0) {
	...
	$insertSQL = "INSERT INTO encomendas (id,store_name, message, numero, id_cliente, nome, nome_envio, morada_fatura, morada_envio, codpostal_fatura, codpostal_envio, localidade_fatura, localidade_envio, pais_envio, pais_fatura, email, telemovel, nif, pagamento, entidade, ref_pagamento, url_pagamento, prods_total, valor_total, valor_iva, valor_c_iva, observacoes, portes_pagamento, portes_entrega, entrega, opcao_texto, opcao, fatura_digital, data, estado, lingua, saldo_compra, codigo_promocional, codigo_promocional_desconto, codigo_promocional_valor, pontos_compra, compra_valor_saldo, pontos_compra_utilizado, envio_link, met_pagamt_id, entrega_id, moeda, valor_conversao, cod_pais) VALUES (:id,'".$store_name."', '".$msg."', :numero, :id_cliente, :nome, :nome_envio, :morada_fatura, :morada_envio, :codpostal_fatura, :codpostal_envio, :localidade_fatura, :localidade_envio, :pais_envio, :pais_fatura, :email, :telemovel, :nif, :pagamento, :entidade, :ref_pagamento, :url_pagamento, :prods_total, :valor_total, :valor_iva, :valor_c_iva, :observacoes, :portes_pagamento, :portes_entrega, :entrega, :opcao_texto, :opcao, :fatura_digital, :data, :estado, '$language', :saldo_compra, :codigo_promocional, :codigo_promocional_desconto, :codigo_promocional_valor, :pontos_compra, :compra_valor_saldo, '0', :envio_link, :met_pagamt_id, :entrega_id, :moeda, :valor_conversao, :cod_pais)";
