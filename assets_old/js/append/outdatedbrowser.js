...
var outdatedBrowser = function(options) {
    ...
    function displayResponse(request) {
        ...
        var ajaxEnglishDefault = '<h6 class="titulos">'+$recursos['outdated_tit']+'</h6>'
            + '<p class="textos">'+$recursos['outdated_txt']+'</p>'
            + '<a class="button invert2" id="btnUpdateBrowser" target="_blank" href="http://outdatedbrowser.com/">'+$recursos['outdated_btn']+'</a>'
            + '<button class="close-button small" id="btnCloseUpdateBrowser" aria-label="Close reveal" role="button" type="button"><span aria-hidden="true">&times;</span></button>';
