...
/*
 * Global function to determine if swal popup is shown
 */
...
var queue = function queue(steps) {
  ...
  var resetQueue = function resetQueue() {
    currentSteps = [];
    document.body.removeAttribute('data-swal-queue-step');
  };
  var queueResult = [];
  return new Promise(function (resolve, reject) {
    (function step(i, callback) {
      if (i < currentSteps.length) {
        document.body.setAttribute('data-swal-queue-step', i);
...
function setParameters(params) {
  ...
  var successIconParts = popup.querySelectorAll('[class^=swal-success-circular-line], .swal-success-fix');
  ...
  if (params.type) {
    ...
    // Animate icon
    if (params.animation) {
      addClass(icon, 'swal-animate-' + params.type + '-icon');
    }
  }
